(function() {
    ...
    function experienceSetup() {
        const SELECTORS = {
            targetImageToAppend: "img[src='/content/dam/voe-azul/lp-de-ofertas/04-05/bnr-livelo_quero_transferir-desktop.png']",
            targetImageToHide: "img[src='/content/dam/voe-azul/lp-de-ofertas/04-05/bnr-livelo_quero_transferir-mobile.png']"
        };
