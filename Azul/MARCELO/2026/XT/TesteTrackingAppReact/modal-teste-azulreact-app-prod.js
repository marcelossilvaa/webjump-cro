(function () {
  ...
  const EXPERIENCE_FLAG = 'AT_TESTE_TRACKING_AZULREACT_APP_PROD';
  const REPORT_SUITE = 'azulreact-app-prod';
  const EVAR82 = 'AT_teste_evar82_azulreact_app_prod';
  const EVAR84 = 'AT_teste_tracking_azulreact_app_prod';
  const STYLE_ID = 'at-teste-azulreact-app-prod-style';
  const MODAL_ID = 'at-teste-azulreact-app-prod-modal';
  const CLOSE_MS = 220;
  ...
  function analyticsEvent(eventLabel, eventType) {
    if (!eventLabel || !eventType) {
      console.log('[Tracking AzulReactAppProd] Parametros ausentes para analytics.');
      return;
    }

    const eVar82Value = EVAR82 + '_' + eventType + '_' + eventLabel;
    console.log(
      '[Tracking AzulReactAppProd] Evento disparado | reportSuite:',
      REPORT_SUITE,
      '| eVar82:',
      eVar82Value,
      '| eVar84:',
    ...
    (function () {
      ...
      if (!s || typeof s.tl !== 'function') {
        console.log(
          '[Tracking AzulReactAppProd] Adobe Analytics indisponivel para suite:',
          REPORT_SUITE
        );
        return;
      }
    ...
    overlay.innerHTML =
      '<div class="at-teste-modal">' +
        '<div class="at-teste-modal__header">' +
          '<span class="at-teste-modal__badge">TESTE PROD</span>' +
        ...
        '<div class="at-teste-modal__body">' +
          ...
          '<p class="at-teste-modal__text">Clique no CTA para enviar eVar82 e eVar84 no report suite do App em producao.</p>' +
    ...
    if (overlay.getAttribute('data-listeners-added') !== 'true') {
      ...
      overlay.addEventListener('click', function (event) {
        ...
        if (action === 'cta') {
          ...
          console.log(
            '[Tracking AzulReactAppProd] CTA clicado. Verifique eVar82 e eVar84 em',
            REPORT_SUITE
          );
        }
      });
