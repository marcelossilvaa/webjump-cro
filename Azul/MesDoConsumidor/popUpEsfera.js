(function () {
  ...
  const ESFERA_LOGO_URL = 'https://i.imgur.com/E8XRyhw.png';
  const DAILY_MAX = 1;
  const INACTIVITY_MS = 50000;
  const CLOSE_ANIMATION_MS = 260;
  const campaignStartMs = new Date(2026, 2, 18, 9, 0, 0).getTime();
  const campaignEndMs = new Date(2026, 2, 22, 23, 59, 0).getTime();
  ...
  function injectStyles() {
    ...
    style.textContent =
      ...
      '.mdc-esfera-azul{font-weight:700;font-size:36px;line-height:44px;color:#19386B;}' +
      '.mdc-esfera-plus{font-size:36px;line-height:44px;color:#041E42;}' +
      '.mdc-esfera-esfera-logo{height:38px;width:auto;max-width:180px;display:block;}' +
      ...
      '.mdc-esfera-azul{font-size:30px;line-height:34px;}' +
      '.mdc-esfera-plus{font-size:30px;line-height:34px;}' +
      '.mdc-esfera-esfera-logo{height:30px;max-width:140px;}' +
  ...
  function getBenefitIconHTML(type) {
    if (type === 'growth') {
      return (
        '<img src="https://i.imgur.com/JOHjW9f.png" alt="" aria-hidden="true" loading="lazy" onerror="if(!this.dataset.fallback){this.dataset.fallback=1;this.src=\'https://i.imgur.com/JOHjW9f.jpg\';}else if(this.dataset.fallback==1){this.dataset.fallback=2;this.src=\'https://i.imgur.com/JOHjW9f.jpeg\';}">'
      );
    }
    if (type === 'travel') {
      return (
        '<img src="https://i.imgur.com/ogZPKXd.png" alt="" aria-hidden="true" loading="lazy" onerror="if(!this.dataset.fallback){this.dataset.fallback=1;this.src=\'https://i.imgur.com/ogZPKXd.jpg\';}else if(this.dataset.fallback==1){this.dataset.fallback=2;this.src=\'https://i.imgur.com/ogZPKXd.jpeg\';}">'
      );
    }
    if (type === 'bonus') {
      return (
        '<img src="https://i.imgur.com/WCt4F0A.png" alt="" aria-hidden="true" loading="lazy" onerror="if(!this.dataset.fallback){this.dataset.fallback=1;this.src=\'https://i.imgur.com/WCt4F0A.jpg\';}else if(this.dataset.fallback==1){this.dataset.fallback=2;this.src=\'https://i.imgur.com/WCt4F0A.jpeg\';}">'
      );
    }
    return (
  ...
  function buildModal(type) {
    ...
    overlay.innerHTML =
      ...
      '      <span class="mdc-esfera-azul">Azul</span>' +
      '      <span class="mdc-esfera-plus">+</span>' +
      '      <img class="mdc-esfera-esfera-logo" src="' +
      ESFERA_LOGO_URL +
      '" alt="Esfera" onerror="if(!this.dataset.fallback){this.dataset.fallback=1;this.src=\'https://i.imgur.com/E8XRyhw.jpg\';}">' +
      '    </div>' +
      ...
      '</span><p>Até <b>133% de bônus</b> exclusivo para assinantes <b>Clube Azul</b> - <a href="https://www.voeazul.com.br/br/pt/programa-fidelidade/clube-azul" target="_blank" rel="noopener">Faça parte</a> e aproveite benefícios exclusivos.</p></li>' +
      '    </ul>' +
