...
(function () {
        ...
        if (!pTaxas) {
          ...
          setTimeout(() => {
            ...
            if (pTaxasRetry) {
              ...
              console.error('Falha ao encontrar "Taxa e impostos" após retry');
            }
          }, 500);
          return false;
        }

        executePromoCode(togglePromo, pTaxas, acordeaoOriginal, formularioParaMover);
      })
      .catch((error) => {
  ...
  function executePromoCode(togglePromo, pTaxas, acordeaoOriginal, formularioParaMover) {
    ...
    console.log('Adobe Target - PromoCode aoLado executado com sucesso');
    return true;
  }
