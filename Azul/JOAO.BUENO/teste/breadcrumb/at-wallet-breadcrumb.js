(function() {
    ...
    const onExperienceTargetPage = () => {
        ...
        const targetTestUrl = "wallet/br/pt/";
    ...
    function experienceSetup() {
        const SELECTORS = {
            currentBreadcrumbNav: "div[data-test-id='payment-container'] .sc-d82c3d10-0.hEAcof",
        };
        ...
        function injectCustomBreadcrumb() {
            ...
            const currentBreadcrumb = currentBreadcrumbNav;
