...
const COUNTDOWN_END_DATE = '2025-11-26 16:30:00';
...
(function () {
  ...
  function createCountdownSection() {
    ...
    countdownContainer.style.cssText =
      'width: 472px; max-height: 70px; background: #041E42; border: 1px solid #00B4E2; border-radius: 10px; padding: 16px; box-sizing: border-box; display: flex; flex-direction: column; gap: 10px; align-items: stretch;';
