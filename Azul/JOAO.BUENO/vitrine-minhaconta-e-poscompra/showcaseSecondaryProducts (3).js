(function() {
    ...
    const CURRENT_PRODUCT_ELEMENT = ".sc-eTtvFv.sPtmc";
    const CTA_PRODUCTS_SELECTOR_TRIGGER_CLICK = "footer > button";
    const CTA_PRODUCTS_SELECTOR_DESCRIPTION = ".sc-eTtvFv .gGIfoK.richTextContainer";
    ...
    function initShowcaseSecondaryProducts() {
        ...
        const currentElementDotList = document.querySelector(".sc-wAnfg.igacOa");
        ...
        function forceDomLoadingOfCurrentProductsSlider() {
            const currentElementArrowsList = document.querySelectorAll(".sc-cyAvAE.icKdnE");
        ...
        function addShowcaseSecondaryProducts() {
            ...
            setTimeout(() => {handleCarouselActions();}, 500);
        }
