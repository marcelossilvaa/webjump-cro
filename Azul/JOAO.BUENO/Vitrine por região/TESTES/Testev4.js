(function () {
  ...
  wrapper.style.maxWidth = "1024"; // largura de 4 cards + 3 gaps = 4*224 + 3*24
...
.css-putdhw h1 {
  ...
  [
    ...
    },
    {
      ...
      priceLabel: "",
      price: "",
      imgSrc: "https://i.imgur.com/p7MDMeo.png",
      buttonUrl: "#",
    },
    {
      title: "Maceió",
  ...
  // --- 7) Dots dinâmicos responsivos e scroll “clamp” ---
  let currentIndex = 0;
  ...
  function rebuildCarousel() {
    ...
    const visibleCount = stepCount;
    // quantas “páginas” cabem
    const maxIndex = Math.ceil((totalCards - visibleCount) / stepCount);
    ...
    for (let i = 0; i <= maxIndex; i++) {
      ...
      dot.addEventListener("click", () => {
        currentIndex = i;
        // calcula offset e clampa
        let offset = i * stepCount * (cardWidth + gapSize);
    ...
    prevBtn.onclick = () => {
      if (currentIndex > 0) {
        currentIndex--;
        let offset = currentIndex * stepCount * (cardWidth + gapSize);
