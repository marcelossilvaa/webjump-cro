(() => {
    ...
    // —————————————
    const scrollToSearchButton = (queryButton) => {
        if(!queryButton) {
            console.error("queryButton não definido para scrollToSearchButton");
            return;
        }

        const searchButton = document.querySelector(queryButton);
    ...
    function Voos() {
        ...
        this.ORIGINAL_SEARCH_BUTTON = "button.sc-jhcsUC.jWayXx.sc-eDCQLT";

        this.QUERY_SELECTORS_INPUTS = {
            DEFAULT: ".sc-eocBVw.fRxbqX input",
        };
        ...
        this.REPLY_ADITIONAL_OPTIONS_CONTAINER = `
            ...
            <div id="injectedSearchButtonContainer">
                ...
                <button type="button" id="injectedSearchButton">Buscar passagens</button>
            </div>
        `;
        ...
        this.ORIGINAL_ADITIONAL_OPTIONS_OBSERVER = new MutationObserver((mutations) => {
            for (const mutation of mutations) {
                ...
                if(originalOptionsHasOptions) {
                    ...
                    scrollToSearchButton(this.ORIGINAL_SEARCH_BUTTON);
                } else {
    ...
    function Hoteis() {
        ...
        this.ORIGINAL_SEARCH_BUTTON = "button.sc-jhcsUC.jWayXx.sc-gSNaSj.lgMroG";
        ...
        this.REPLY_ADITIONAL_OPTIONS_CONTAINER = `
            ...
            <div id="injectedSearchButtonContainer" style="margin-top: 24px">
                <div class="grouped-search-container">
                    ...
                    <button type="button" id="injectedSearchButton">Buscar hotéis</button>
                </div>
            </div>
        `;
    ...
    function Ingressos() {
        ...
        this.ORIGINAL_SEARCH_BUTTON = "button.sc-jhcsUC.jWayXx.sc-fJAwkm.YtAFk.sc-dtOhJP";
        ...
        this.REPLY_ADITIONAL_OPTIONS_CONTAINER = `
            ...
            <div id="injectedSearchButtonContainer" style="margin-top: 24px">
                <div class="grouped-search-container">
                    ...
                    <button type="button" id="injectedSearchButton">Buscar ingressos</button>
                </div>
            </div>
        `;
    ...
    function Carros() {
        ...
        this.ORIGINAL_SEARCH_BUTTON = "button.sc-jhcsUC.jWayXx.sc-hRzftK";
        ...
        this.REPLY_ADITIONAL_OPTIONS_CONTAINER = `
            ...
            <div id="injectedSearchButtonContainer" style="margin-top: 24px">
                <div class="grouped-cars">
                    <button type="button" id="injectedSearchButton">Buscar carros</button>
                </div>
            </div>
        `;
