      (function() {
          const experienceName = "AT_EXPERIENCE_INSURANCE_EMPHASIS";
          ...
          function experienceSetup() {
              ...
              const SELECTORS = {
                  ...
                  insuranceBanner: ".LuggageAdderContainer .styles__InsuranceBannerContainer-sc-1kgy9y2-0",
                  tripsList: ".LuggageAdderContainer .react-tabs__tab-list li",
                  buttonAdderInsurance: ".LuggageAdderContainer .styles__InsuranceButtonContainer-sc-12knqgp-0.WGuua",
                  buttonSubmitCheckout: ".LuggageAdderContainer button[type='submit']",
                  insurancePrice: ".LuggageAdderContainer .styles__InsuranceBannerContainer-sc-1kgy9y2-0 .congressblue",
              };
              ...
              function reviewCheckoutObserverCallback(mutations) {
                  for (const mutation of mutations) {
                      if (mutation.addedNodes.length > 0 || mutation.removedNodes.length > 0) {
                          ...
                          if (insuranceBanner) {
                              const tripsList = document.querySelectorAll(SELECTORS.tripsList);
                              const hasGoAndBackTrip = tripsList.length > 1;
                              injectInsuranceContainer(hasGoAndBackTrip, insuranceBanner);
                              return;
                          }
                      }
                  }
              ...
              function injectInsuranceContainer(hasGoAndBackTrip = false, insuranceBanner) {
                  if (!insuranceBanner) {
                  ...
                  const insuranceElement = createInsuranceElement(hasGoAndBackTrip);
              ...
              function createInsuranceElement(hasGoAndBackTrip = false) {
                ...
                <form class="injectedInsuranceWrapper__form">
                    <div class="injectedInsuranceWrapper__form__wrapper">
                        <input type="radio" name="insurances" id="insurance_yes" checked>
                        <label for="insurance_yes" class="injectedInsuranceWrapper__label">
                            ...
                            <div class="injectedInsuranceWrapper__label__content">
                                <ul class="injectedInsuranceWrapper__benefits" id="benefits_has_go_and_back_trip">
                                    <li class="injectedInsuranceWrapper__benefits__item"><span><strong>Despesas médicas, hospitalares e Odontológicas</strong> em viagem</span></li>
                                    <li class="injectedInsuranceWrapper__benefits__item"><span><strong>Despesas farmacêuticas</strong></span></li>
                                    <li class="injectedInsuranceWrapper__benefits__item"><span><strong>Roubo/Furto</strong> de celular ou notebook</span></li>
                                    <li class="injectedInsuranceWrapper__benefits__item"><span>Coberturas para seu <strong>PET</strong></span></li>
                                </ul>
                                <ul class="injectedInsuranceWrapper__benefits" id="benefits_doesnt_go_and_back_trip">
                                    <li class="injectedInsuranceWrapper__benefits__item"><span><strong>Despesas médicas, hospitalares e Odontológicas</strong> em viagem</span></li>
                                    <li class="injectedInsuranceWrapper__benefits__item"><span><strong>Cancelamento de viagem</strong></span></li>
                                </ul>
                    ...
                    <div class="injectedInsuranceWrapper__form__wrapper">
                        <input type="radio" name="insurances" id="insurance_no">
            ...
            `;
                  ...
                  if (hasGoAndBackTrip) {
                      div.querySelector("#benefits_doesnt_go_and_back_trip").remove();
                  } else {
                      div.querySelector("#benefits_has_go_and_back_trip").remove();
                  }
            ...
            `;
              ...
              function injectCustomCSS() {
                ...
                .injectedInsuranceWrapper__benefits__item::before {
                    content: url('data:image/svg+xml,<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M17.4998 9.99991C17.4998 14.142 14.142 17.4998 9.99991 17.4998C5.85783 17.4998 2.5 14.142 2.5 9.99991C2.5 5.85783 5.85783 2.5 9.99991 2.5C14.142 2.5 17.4998 5.85783 17.4998 9.99991Z" fill="%23229971"/><path fill-rule="evenodd" clip-rule="evenodd" d="M13.5928 6.84341L14.1782 7.44446L8.94544 12.818L6.16287 9.96089L6.74891 9.35989L8.94544 11.6152L13.5928 6.84341Z" fill="white"/></svg>');
                }

                .injectedInsuranceWrapper__benefits__item strong {
                    font-weight: 700;
                }

                .injectedInsuranceWrapper__label__content > span {
                    color: #212121;
                    font-size: 12px;
                }
