  (function() {
    const experienceName = "AT_EXPERIENCE_CALCULATOR_LIVELO";
    const experienceTargetUrls = [
        "ofertas/livelo-teste",
        "ofertas/livelo",
        "ofertas/livelo-app",
        "ofertas/livelo-midia",
        "ofertas/livelo-push",
        "ofertas/livelo-emkt",
        "ofertas/livelo-social",
        "ofertas/livelo-parceiro"
    ];
    const experienceAlreadyExecuted = window[experienceName] || false;

    const onExperienceTargetPage = () => {
        const currentUrl = window.location.pathname;
        const testUrl = experienceTargetUrls.find(url => currentUrl.includes(url)) || "";
    ...
    function experienceSetup() {
        const SELECTORS = {
            targetImageToAppend: "img[src='/content/dam/voe-azul/lp-de-ofertas/26-02/calculadora-pontos-desktop.png']",
            targetImageToHide: "img[src='/content/dam/voe-azul/lp-de-ofertas/26-02/bnr-transfira-pontos-desktop.png']"
        };
                ...
                <div class="injectedCalculator__controlledWrapper">
                    ...
                    <div data-active="isClube" class="injectedCalculator__controlledWrapper__content injectedCalculator__isClub active">
                        ...
                        <div class="injectedCalculator__isClub__content">
                            <a class="injectedCalculator__isClub__button" href="https://www.livelo.com.br/livelo-para-parceiros/azul/AZLTransfer" target="_blank">Quero transferir</a>
                            <small class="injectedCalculator__isClub__disclaimer">Válido de 02 a 05/03/2026. Consulte condições.</small>
                        </div>
                    </div>
                </div>
            `;
        ...
        function handleCalculatorLogic() {
            ...
            // Multiplicadores por faixa de tempo de clube (value dos radios)
            const MULTIPLIERS = {
                "6monthsminus":           1.03,  // < 6 meses
                "between6months11months": 1.08,  // 6 a 11 meses
                "between12months35months":1.13,  // 12 a 35 meses
                "between36months59months":1.23,  // 36 a 59 meses
                "60monthsplus":           1.33,  // > 60 meses
            };

            // Detecta se o usuário é "Não Clube" ou qual faixa de clube
            function getMultiplier() {
                // Aba "Não" ativa → não é clube
                const notClubActive = document.querySelector(
                    '[data-active="notClube"].injectedCalculator__controlledWrapper__content.active'
                );
                if (notClubActive) return 0.80;

                // Aba "Sim" → olha o radio selecionado
                const checked = document.querySelector(
                    '.injectedCalculator__form__timeOption input[type="radio"]:checked'
                );
                if (checked && MULTIPLIERS[checked.value] !== undefined) {
                    return MULTIPLIERS[checked.value];
                }

                // fallback: clube < 6 meses
                return 1.03;
            }

            // Atualiza bônus e total com base nos valores atuais
            ...
            const timeRadios = document.querySelectorAll(
                '.injectedCalculator__form__timeOption input[type="radio"]'
            );
            ...
            controllerButtons.forEach(function (btn) {
                btn.addEventListener("click", function () {
                    // aguarda handleControllerClientType aplicar a classe active
        ...
        function injectCustomCSS() {
            ...
            style.innerHTML = `
                ...
                @media screen and (min-width: 1024px) {
                    ...
                    .injectedCalculator__form__timeOption label::before {
                        content: url('data:image/svg+xml,<svg width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="50.8189" height="50.8189" rx="25.4095" fill="%230061A0" fill-opacity="0.2"/></svg>');
                        font-size: 0;
                    }

                    .injectedCalculator__form__timeOption input:checked + label::before {
                        content: url('data:image/svg+xml,<svg width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="50.8189" height="50.8189" rx="25.4095" fill="%230061A0" fill-opacity="0.2"/><rect x="5.86328" y="5.86328" width="39.0915" height="39.0915" rx="19.5457" fill="%230061A0"/></svg>');
                    }
                ...
                @media screen and (min-width: 1400px) {
                    ...
                    .injectedCalculator__form__inputWrapper.--total {
                        flex-shrink: 0;
                        width: 440px;
                    }
