(function() {
    const experienceName = "AT_EXPERIENCE_CALCULATOR_MULTIBANCOS";
    const experienceTargetUrls = [
        "ofertas/bancos",
        "ofertas/bancos-teste",
    ];
    ...
    function experienceSetup() {
        const SELECTORS = {
            ...
            targetImageToHide: "img[src='/content/dam/voe-azul/lp-de-ofertas/26-02/cta-quero_transferir-desktop.png']"
        };
                ...
                <div class="injectedCalculator__controlledWrapper">
                    ...
                    <div data-active="isClube" class="injectedCalculator__controlledWrapper__content injectedCalculator__isClub active">
                        ...
                        <div class="injectedCalculator__isClub__content">
                            ...
                            <small class="injectedCalculator__isClub__disclaimer">Válido de 02 a 06/03/2026. Consulte condições.</small>
                        </div>
                    </div>
                </div>
            `;
