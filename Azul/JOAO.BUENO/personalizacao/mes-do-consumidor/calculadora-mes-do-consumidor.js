    (function() {
        // ===== JANELA DA CAMPANHA =====
        const campaignStartMs = new Date(2026, 3, 20, 0, 0, 0).getTime();
        const campaignEndMs = new Date(2026, 4, 31, 23, 59, 0).getTime();
        ...
        const selectors = {
            ...
            hours: '.modalFacInjected__countdown__data[type="hours"] .modalFacInjected__countdown__data__number',
            minutes: '.modalFacInjected__countdown__data[type="minutes"] .modalFacInjected__countdown__data__number',
            seconds: '.modalFacInjected__countdown__data[type="seconds"] .modalFacInjected__countdown__data__number',
        };
