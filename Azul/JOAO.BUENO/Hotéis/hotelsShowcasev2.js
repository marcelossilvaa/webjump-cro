(function() {
    ...
    const HOTELS = [
        {
            ...
            locale: 'Orlando.',
            image: 'http://images.azulviagens.com.br/images/upload//hotels/Rosen_Inn_at_Pointe_Orlando/001.jpg',
        ...
        },
        {
            ...
            image: 'https://www.azulviagens.com.br/handlers/imageRequest.ashx?path=https%3A%2F%2Fwww.dotwconnect.com%2Fpoze_hotel%2F21%2F211736%2FSs6Fv6SA_c6bce763f38d7a57d0c7e42e482f6cc4.jpg',
        ...
        },
        {
            ...
            locale: 'Kissimmee.',
            image: 'http://images.azulviagens.com.br/images/upload//hotels/Celebration_Suites/WhatsApp_Image_2021-12-06_at_15.25.40.jpeg',
        ...
        },
        {
            ...
            locale: 'Orlando.',
            image: 'http://images.azulviagens.com.br/images/upload/hotels/Clarion_Inn_Lake_Buena_Vista/1.JPG',
    ...
    const initializeShowcase = () => {
        ...
        function injectShowcase() {
            ...
            if(!contentWrapper) {
                console.log("[AT] Content wrapper not found: " + SELECTORS.contentWrapper);
                return;
            }
            ...
            contentWrapper.insertAdjacentElement("beforebegin", showcaseContainer);
        ...
        function handleCarouselScroll(direction = "next") {
            ...
            const scrollWidth = showcaseList.querySelector(".inject-hotel-showcase-item").clientWidth + carouselGap;
        ...
        function createHotelElement(hotel) {
            ...
            showcaseItem.innerHTML = `
                <a class="inject-hotel-showcase-item__wrapper" href="[INSERT_LINK]" target="_blank" rel="noopener noreferrer">
                    ...
                    <div class="inject-hotel-showcase-item__content">
                        ...
                        <div class="inject-hotel-showcase-item__cta" role="button">Conheça o hotel</div>
                    </div>
                </a>
            `;
            ...
            showcaseItem.querySelector(".inject-hotel-showcase-item__wrapper").addEventListener("click", () => {
            ...
            const loadingObserver = new MutationObserver((mutations) => {
                mutations.forEach((mutation) => {
                    if(mutation.removedNodes.length > 0 || mutation.addedNodes.length > 0) {
                        ...
                        if(listWrapper && !listWrapper.hasAttribute("hidden")) {
                            console.log("[AT] List wrapper is visible, re-injecting showcase if destiny is Orlando...");
        ...
        function injectCustomStyles() {
            ...
            style.textContent = `
                ...
                .inject-hotel-showcase-item__cta {
                    cursor: pointer;
                    margin-top: auto;
                    background: #041e42;
                    padding: 10px 16px;
        ...
        function destinyIsOrlando() {
            const destiny = document.querySelector(SELECTORS.destiny)?.textContent || document.querySelector(SELECTORS.destinyMoba)?.textContent ||"";
        ...
        function analyticsEvent(hotelName = "") {
            ...
            const labelEvent = "AT_vitrine_hoteis_v2 " + hotelName;
    ...
    if(window.showcaseInjectedV2) {
        return;
    }

    window.showcaseInjectedV2 = true;
    checkIfDomReady();
})();