      ...
      <div class="vantagens-grid">
        <a href="https://passagens.voeazul.com.br/pt/buscador-de-precos" class="vantagem-card">
          <div class="container-img">
            ...
            <img src="https://i.imgur.com/BWzDr0w.png" alt="Buscador de Preços" class="vantagem-imagem img-desktop">
            <img src="https://i.imgur.com/wvJKdH6.png" alt="Buscador de Preços" class="vantagem-imagem img-mobile">
          </div>
          <div class="vantagem-conteudo">
            ...
            <span class="vantagem-link">Confira</span>
          </div>
        </a>
        <a href="https://www.azulviagens.com.br/" class="vantagem-card">
          <div class="container-img">
            <span class="container-img-span">Conheça nossos pacotes</span>
            <img src="https://i.imgur.com/XQJFStR.png" alt="Viagem Completa" class="vantagem-imagem img-desktop">
            <img src="https://i.imgur.com/gAI0GTV.png" alt="Viagem Completa" class="vantagem-imagem img-mobile">
          </div>
          <div class="vantagem-conteudo">
            ...
            <span class="vantagem-link">Aproveite</span>
          </div>
        </a>
        <a href="https://www.voeazul.com.br/br/pt/ofertas" class="vantagem-card">
        <div class="container-img">
        <span class="container-img-span">Ofertas Azul</span>
        <img src="https://i.imgur.com/bxuNtP6.png" alt="Ofertas Azul" class="vantagem-imagem img-desktop">
        <img src="https://i.imgur.com/roUSCcB.png" alt="Ofertas Azul" class="vantagem-imagem img-mobile">
        </div>
        <div class="vantagem-conteudo">
        ...
        <a href="https://www.voeazul.com.br/br/pt/sua-viagem/experiencia-azul" class="vantagem-card">
          <div class="container-img">
            ...
            <img src="https://i.imgur.com/zYD5aE1.png" alt="Experiência Azul" class="vantagem-imagem img-desktop">
            <img src="https://i.imgur.com/2a9t4G9.png" alt="Experiência Azul" class="vantagem-imagem img-mobile">
          </div>
          <div class="vantagem-conteudo">
            ...
            <span class="vantagem-link">Conheça</span>
          </div>
        </a>
      </div>
    </div>
