    ...
    const initilizeFiltersOptimization = () => {
        ...
        function injectCustomStyles() {
            ...
            style.textContent = `
                ...
                .inject-results-element .styles__CarsGroupWrapper-sc-fdgbpv-3 .styles__CarsGroupWrapper-sc-nnv2sb-0:first-child .drvwcB { 
                    padding: 0;
                }
                ...
                @media screen and (max-width: 1439px) {
                    ...
                    .inject-results-element .styles__ContentWrapper-sc-nnv2sb-1 {
                        width: 100%;
                    }

                    .inject-results-element  .styles__Container-sc-ccr6q9-0 {
                        width: 100%;
                        height: auto;
                        min-height: 320px;
                        align-items: center;
                    ...
                    .inject-results-element .styles__ContainerImage-sc-ccr6q9-1 {
                        height: auto;
                    }

                    .inject-results-element .styles__ContainerDetails-sc-ccr6q9-3 {
                        width: 300px;
                        padding-left: 0;
                    }

                    .inject-results-element .styles__ContainerSubtitle-sc-ccr6q9-6 {
                        flex-wrap: wrap;
                    }

                    .inject-results-element .styles__SubtitleWrapper-sc-ccr6q9-7 {
                        margin-left: 0;
                    }

                    .inject-results-element .styles__AmenitiesWrapper-sc-ccr6q9-11 {
                        flex-wrap: wrap;
                        display: flex;
                    }

                    .inject-results-element .styles__PriceWrapper-sc-10ygdxz-0 {
                        align-self: flex-start;
                    }

                    .inject-results-element .styles__AccrualInfo-sc-10ygdxz-6  {
                        align-items: flex-start;
                        gap: 1px;
                    }

                    .inject-results-element .styles__BackgroundAccrual-sc-10ygdxz-2  {
                       height: 108px;
                    }

                    .inject-results-element .styles__PriceContentWrapper-sc-10ygdxz-9 {
                        margin-top: 25px;
                        margin-bottom: 15px;
                    }
                }
