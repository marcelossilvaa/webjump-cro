(function () {
  ...
  function injectStyles() {
    ...
    var rules = [
      ...
      "gap: 12px;",
      "padding: 20px 16px 20px 16px;", // espaçamento entre cada bloco
      "}",

      /* container principal empilhado */
      "#" + SETTINGS.componentId + " {",
      "display: flex;",
      "flex-direction: column;",
      "align-items: stretch;",
      ...
      /* bloco de texto: descrição abaixo do header */
      "#" + SETTINGS.componentId + " .cta-text {",
      ...
      /* título dentro do header, sem margem extra */
      "#" + SETTINGS.componentId + " .cta-title {",
      "margin: 0;",
      "font-size: 16px;",
      "font-weight: 400;",
      ...
      /* botão full-width e centralizado */
      "#" + SETTINGS.componentId + " .cta-button {",
      "display: block;",
      "width: 100%;",
      "margin: 0;",
      "align-self: center;",
      "font-size: 16px;", // centraliza caso queira largura fixa
      "}",
...
function hasRegisterButtonText() {
  return Array.from(document.body.querySelectorAll("button"))
    .some(btn => btn.textContent.trim() === "Realizar cadastro");
}

// atualize sua userNeedsRegistration() para combinar ambas as verificações
function userNeedsRegistration() {
  // já tinha:
  var promptExists = !!document.querySelector(SETTINGS.registerPromptSelector);
  // nova garantia:
