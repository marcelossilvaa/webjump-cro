(function () {
  ...
  function injetarEstilos() {
    ...
    style.textContent = [
      ...
      // Card reestruturado para o split 50/50 (layout horizontal compacto)
      ...
      // Wrapper interno: layout horizontal (imagem esquerda, conteudo direita)
      ...
      // Slider de imagem: coluna esquerda fixa
      ...
      // Coluna direita: conteudo (info + preco lado a lado ou empilhado)
      ...
      // InfosWrapper: garantir containment
      ...
      // Nome do hotel - permite ate 2 linhas
      ...
      '  margin-top: 2px;',
      '}',
      '[' + DATA_APLICADO + '] [class*="HotelNameWrapper-sc"] svg {',
      ...
      // Preco: layout compacto na parte inferior do conteudo
      ...
      // Acumule pontos: compacto inline
      ...
      '  font-size: 13px !important;',
      '  border-radius: 6px;',
      '  background: rgb(1, 78, 132) !important;',
      '  color: #fff !important;',
      '  border: none !important;',
