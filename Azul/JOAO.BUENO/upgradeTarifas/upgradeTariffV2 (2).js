    ...
    const initializeUpgradePromo = () => {
                    ...
                    <div class="inject-upgrade-tariff [tariff_class]" role="alert" aria-label="Oferta de melhoria de tarifa">
                        ...
                        <div class="inject-upgrade-tariff__cta">
                            <h3 class="inject-upgrade-tariff__name">
                                Faça um upgrade para <span class="inject-upgrade-tariff__name__highlight">Business</span>
                            </h3>
                            <p class="inject-upgrade-tariff_subtitle">Com toda a comodidade, gastronomia e entretenimento de primeira, a Azul Business e sua Tripulação vão fazer você se sentir mais do que especial.</p>
        ...
        function injectCustomStyle() {
            ...
            style.innerHTML = `
                ...
                .inject-upgrade-tariff_subtitle {
                    color: #606060;
                    font-size: 12px;
                    text-align: center;
                }
