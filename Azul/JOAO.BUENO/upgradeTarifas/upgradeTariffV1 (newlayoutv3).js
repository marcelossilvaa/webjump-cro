(function () {
    ...
    const tariffs = {
        maisAzul: {
            ...
            benefits: [
                "Antecipação de voo",
                "Marcação de assento antecipado",
            ],
            carousel: [
                {
                    image: "https://www.voeazul.com.br/content/dam/azul/folder/experiencia-azul/img_economyxtra.png",
                    title: "Antecipe escolha de assento e de voo",
                }
            ]
        },
        azulSuper: {
