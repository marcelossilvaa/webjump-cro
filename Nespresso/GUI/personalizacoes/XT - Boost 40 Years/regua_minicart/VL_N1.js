(function () {
  ...
  const giftTiers = [
    {
      threshold: 50,
      gift: "10 Cafés Voltesso",
      shortName: "10 cafés Voltesso",
      displayName: "GANHE 10 CAFÉS VOLTESSO",
      imageUrl:
        "https://www.nespresso.com/ecom/medias/sys_master/public/50245620072478/Dinamic-Banner-VL-N1.jpg?attachment=true&cimgnr=F1z7A", // Substitua pela URL da imagem real
    },
    {
      threshold: 70,
      gift: "1 Toalha Barista",
      shortName: "1 Toalha Barista",
      displayName: "1 TOALHA BARISTA",
      imageUrl:
        "https://www.nespresso.com/ecom/medias/sys_master/public/50245618597918/Dinamic-Banner-OL-N2.jpg?attachment=true&cimgnr=XKKRp", // Substitua pela URL da imagem real
    },
    {
      threshold: 120,
      gift: "1 Xícara Pixie Lungo",
      shortName: "1 Xícara Pixie Lungo",
      displayName: "1 XÍCARA PIXIE LUNGO",
      imageUrl:
        "https://www.nespresso.com/ecom/medias/sys_master/public/50245618663454/Dinamic-Banner-OL-N3.jpg?attachment=true&cimgnr=y5dac", // Substitua pela URL da imagem real
    },
    {
      threshold: 180,
      gift: "1 Caneca Térmica",
      shortName: "1 Caneca Térmica",
      displayName: "1 CANECA TÉRMICA",
      imageUrl:
        "https://www.nespresso.com/ecom/medias/sys_master/public/50245618728990/Dinamic-Banner-OL-N4.jpg?attachment=true&cimgnr=2tJvy", // Substitua pela URL da imagem real
    },
    {
      threshold: 210,
      gift: "1 Par de Xícaras Pixie Espresso",
      shortName: "1 Par de Xícaras Pixie Espresso",
      displayName: "1 PAR DE XÍCARAS PIXIE ESPRESSO",
      imageUrl:
        "https://www.nespresso.com/ecom/medias/sys_master/public/50245618794526/Dinamic-Banner-OL-N5.jpg?attachment=true&cimgnr=5yWu6", // Substitua pela URL da imagem real
    },
  ];
    ...
    styleEl.textContent = `
              .MiniBasketDropdown__wrapper .BenefitMessage, .MiniBasketDropdown__wrapper #minicart-freight-component, #MiniBasketPush{
                    ...
                    .nespresso-shimmer-effect {
                      ...
                      border:3px solid #af271a !important;
  ...
  const renderOffersComponent = (container, totalCapsules) => {
    ...
    if (tierInfo.nextTier) {
      nextTierInfoHtml =
        ...
        tierInfo.capsulesToNextTier +
        ` cápsulas</span></strong> para ganhar: <span style="font-size: 13px; color: #ad2315; font-weight: 700; margin: 0;">` +
        tierInfo.nextTier.gift +
        `</span>
                      </p>
                    </div>
