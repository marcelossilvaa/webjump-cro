(function () {
  ...
  const CARDS_CONFIG = [
...

    {
      ...
      enabled: true,
      position: 5,
      targetCollections: ["capsule-range-espressos"],
      filterCondition: "0",
      hasBackground: false,
      variants: {
        ol: {
          banner: "https://iili.io/FDrj2WP.png",
          titulo: "",
          paragrafo: "",
        },
        vl: {
    ...
    },
    {
      ...
      enabled: true,
      position: 5,
      targetCollections: ["capsule-range-ispirazione-italiana"],
      filterCondition: "0",
      hasBackground: false,
      variants: {
        ol: {
          banner: "https://iili.io/FDrjKqF.png",
          titulo: "",
          paragrafo: "",
        },
        vl: {
    ...
    },
    {
      ...
      enabled: true,
      position: 5,
      targetCollections: ["capsule-range-world-explorations"],
      filterCondition: "0",
      hasBackground: false,
      variants: {
        ol: {
          banner: "https://iili.io/FDrj3s1.png",
          titulo: "",
          paragrafo: "",
        },
        vl: {
