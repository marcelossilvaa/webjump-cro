(function () {
  if (window.popInDiaDasMaes) {
    return;
  }
  window.popInDiaDasMaes = "true";
  ...
  function sendEventGA(label) {
    ...
    gtmDataObject.push({
      event: "local_event",
      event_raised_by: "br",
      local_event_category: "dia_das_maes",
  ...
  function iniciarContainer() {
    var config = {
      imagemUrl:
        "https://www.nespresso.com/ecom/medias/sys_master/public/50832189030430/Gif.gif?",
      imagemAlt: "Ganhe Porta-cápsulas LUME MIA G na compra de 300 cafés",
    ...
    link.addEventListener("click", function () {
      sendEventGA("clicou_comunicacao_pop_in");
    });
    botaoFechar.addEventListener("click", function (e) {
      sendEventGA("fechou_comunicacao_pop_in");
      e.preventDefault();
      e.stopPropagation();
    ...
    if (!jaFechado) {
      ...
      sendEventGA("visualizou_comunicacao_pop_in");
