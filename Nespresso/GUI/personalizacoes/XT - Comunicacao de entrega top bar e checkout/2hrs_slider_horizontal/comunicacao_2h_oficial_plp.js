(function () {
  "use strict";
  if (window.comunicacao2hrs) return;
  window.comunicacao2hrs = true;
  ...
  function createSlider() {
    ...
    const messages = [
      {
        text: "<strong>ÚLTIMOS DIAS DE BLACK FRIDAY</strong>",
...
<td style="text-align: left; padding: 8px 4px;">até 4 dias úteis</td>
<td style="text-align: left; padding: 8px 8px 8px 4px;">até 7 dias úteis</td>
</tr>
<tr style="border-bottom: 1px solid #eee;">
...
<td style="text-align: left; padding: 8px 4px;">até 9 dias úteis</td>
<td style="text-align: left; padding: 8px 8px 8px 4px;">até 12 dias úteis</td>
</tr>
</tbody>
      ...
      {
        text: "<strong>Frete Grátis</strong> em até <strong>2 dias úteis</strong>: SP, RJ, DF e PE*",
