  ...
  const updateBanner = (totalCapsules) => {
    ...
    if (tierInfo.nextTier) {
      if (totalCapsules !== 0) {
        ...
        mainText.innerHTML = `Adicione <strong>120 cápsulas</strong> para ganhar: <strong>R$ 80 no próximo pedido.*</strong>`;
      }
    } else {
    ...
    if (tierInfo.nextTier) {
      if (totalCapsules !== 0) {
        ...
        minimizedTab.innerHTML = `Adicione <strong>120 cápsulas</strong> para ganhar <strong>R$80 de crédito</strong>`;
      }
    } else {
