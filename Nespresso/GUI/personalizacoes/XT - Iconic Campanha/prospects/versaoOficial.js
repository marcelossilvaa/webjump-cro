(function () {
  ...
  const CONFIG = {
    ol: {
      banner:
        "https://www.nespresso.com/ecom/medias/sys_master/public/44887598465054/Banner-PLP-432x692-Proposta-01.jpg?attachment=true&cimgnr=Niv4E",
    ...
    vl: {
      banner:
        "https://www.nespresso.com/ecom/medias/sys_master/public/44887599743006/Banner-PLP-432x692-Proposta-02.jpg?attachment=true&cimgnr=zWFCQ",
      titulo: "OFERTA DE <span class='boldCrossSellCards'>BOAS VINDAS</span>",
      paragrafo: "Compre 70 cafés e ganhe 10 cápsulas de presente*",
      ctaText: "FAÇA LOGIN",
      ctaLink:
    ...
    teste: {
      banner: "https://iili.io/3yivn2e.jpg",
    },
  };
              ...
              categoriasPLP.forEach(function (categoria, index) {
                ...
                if (articles.length >= 6) {
                  ...
                  if (!isTablet) {
                    ...
                    categoria.insertBefore(
                      novoClone,
                      articles[posicaoAleatoria]
                    );
                  }
                }
              });
