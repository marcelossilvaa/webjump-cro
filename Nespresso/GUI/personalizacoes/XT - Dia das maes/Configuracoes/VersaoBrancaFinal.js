(function () {
  if (window.novoComponenteDiaDasMaes || window.innerWidth >= 825) {
    return;
  }
              ...
              <div class="accordion">
                  ...
                  <div class="accordion-content">
                      <div class="accordion-body">
                          ...
                          <div class="offer-item">
                              <div class="offer-image">
                                  <img src="https://www.nespresso.com/ecom/medias/sys_master/public/44601421824030/Stick-banner-400x400-N3.png?" alt="Biscoito Lemon Shortbread + Xícara">
                              </div>
                              <div class="offer-text">
                                  <h3>Ganhe 1 Caixa de Biscoito Lemon + 1 Xícara Cappuccino</h3>
