(function () {
  if (window.novoComponenteDiaDasMaes || window.innerWidth > 600) {
    return;
  }
  window.novoComponenteDiaDasMaes = "true";
                        ...
                        <div class="accordion-body">
                            <div class="offer-item">
                                <div class="offer-image">
                                    <img src="https://www.nespresso.com/ecom/medias/sys_master/public/44600470372382/Stick-banner-400x400-N1.png?" alt="Biscoito Lemon Shortbread">
                                </div>
                                <div class="offer-text">
                                    <h3>Ganhe 1 Caixa de Biscoito Lemon</h3>
                                    <p>Na compra de <span class="boldCoffesTexts">70 cafés</span></p>
                                </div>
                            </div>
                            <div class="offer-item">
                                <div class="offer-image">
                                    <img src="https://www.nespresso.com/ecom/medias/sys_master/public/44601421660190/Stick-banner-400x400-N2.png?" alt="Porta-cápsulas médio">
                                </div>
                                <div class="offer-text">
                                    <h3>Ganhe 1 Porta-Cápsulas</h3>
                                    <p>Na compra de <span class="boldCoffesTexts">100 cafés</span></p>
                                </div>
                            </div>
                            <div class="offer-item">
                                <div class="offer-image">
                                    <img src="https://www.nespresso.com/ecom/medias/sys_master/public/44749037109278/Stick-banner-400x400-N3.png?attachment=true&cimgnr=Zwbz2" alt="Biscoito Lemon Shortbread + Copo Barista">
                                </div>
                                <div class="offer-text">
                                    <h3>Ganhe 1 Caixa de Biscoito Lemon + 1 Copo Barista</h3>
                                    <p>Na compra de <span class="boldCoffesTexts">150 cafés</span></p>
                                </div>
                            </div>
                            <div class="offer-item">
                                <div class="offer-image">
                                    <img src="https://www.nespresso.com/ecom/medias/sys_master/public/44601422250014/Stick-banner-400x400-N4.png?" alt="Kit para Servir + Xícara">
                                </div>
                                <div class="offer-text">
                                    <h3>Ganhe 1 Kit para servir + 1 Xícara Cappuccino</h3>
                                    <p>Na compra de <span class="boldCoffesTexts">200 cafés</span></p>
                                </div>
                            </div>
                            <div class="offer-item">
                                <div class="offer-image">
                                    <img src="https://www.nespresso.com/ecom/medias/sys_master/public/44601422413854/Stick-banner-400x400-N5.png?" alt="Par de Canecas Lume">
                                </div>
                                <div class="offer-text">
                                    <h3>Ganhe 1 Par de Canecas Lume</h3>
          ...
          <div class="modal-container">
            ...
            <div class="modal-content">
              <div class="modalTermosECondicoesCampanhaMaes">
                ...
                <strong>OFERTA DIA DAS MÃES NESPRESSO – 24.04.2025 à 12.05.2025</strong><br>
                <br>
                Oferta válida de 24/04/2025 a 12/05/2025, sujeita a alterações sem aviso prévio.  Compre a partir de 150 cápsulas Original Line ou Vertuo Line Nespresso e ganhe 1 biscoito Lemon Shortbread 
                Nespresso e 1 xícara Barista Cappuccino Nespresso; Na compra a partir de 200 cápsulas Original Line ou Vertuo Line Nespresso ganhe 1 kit para servir Nespresso + 1 xícara barista cappuccino 
                Nespresso; Na compra a partir de 250 cápsulas Original Line ou Vertuo Line Nespresso ganhe 1 Par de canecas Lume Nespresso. A oferta é única, intransferível e não cumulativa com outras ofertas 
                em andamento, válida para pessoas físicas e limitada a um uso por CPF de resgistro na Nespresso. Imagens meramente ilustrativas.
              </div>
            </div>
          </div>
        `;
