  ...
  const CAMPANHA_CONFIG = {
    ...
    ofertas: [
      {
        ...
        titulo: "Ganhe 10 cafés Double Espresso Scuro",
        alt: "10 cafés Double Espresso Scuro",
      },
      {
        quantidadeCafes: 70,
        imagem:
      ...
      },
      {
        ...
        titulo: "Ganhe 1 Caneca Térmica Pequena",
        alt: "1 Caneca Térmica Pequena",
      },
      {
        quantidadeCafes: 180,
        imagem:
    ...
    modal: {
      ...
      conteudo: `
        ...
        <br>
        *Oferta exclusiva e válida por tempo limitado de 28/07/2025 a 11/08/2025, sujeita a alterações sem aviso prévio. Compre a partir de 120 cápsulas Vertuo Line Nespresso e ganhe uma Caneca Térmica Pequena Sage Green Nespresso. O pedido deve conter apenas cápsulas da linha Vertuo ou, compre a partir de 180 cápsulas Vertuo Line Nespresso e ganhe uma Caneca Térmica Média Vanilla Ice Nespresso. O pedido deve conter apenas cápsulas da linha Vertuo.
