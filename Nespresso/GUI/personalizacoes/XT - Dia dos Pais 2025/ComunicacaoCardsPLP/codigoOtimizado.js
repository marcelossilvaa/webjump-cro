(function () {
  ...
  function createCardElement(cardConfig, templateArticle) {
    ...
    if (variantConfig.paragrafo) {
      htmlParts.push(
        `<p class="paragrafoCardCrossSell">${variantConfig.paragrafo}</p>`
      );
    }
    ...
    if (variantConfig.termsText && variantConfig.modalContent) {
      ...
      htmlParts.push(
        `<p class="termsCrossSell"><a href="#" class="linkTermsCustomCard" data-modal-id="${modalId}">${variantConfig.termsText}</a></p>`
      );
    }
