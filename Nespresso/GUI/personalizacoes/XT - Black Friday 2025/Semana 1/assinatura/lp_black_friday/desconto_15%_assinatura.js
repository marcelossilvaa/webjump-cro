(function () {
  ...
  let buscaElementoCPD = setInterval(function () {
    const elementoCPD = document.querySelector(
      "#page-builder-c8685e83-330a-ab63-3309-84bbbf8862e8"
    );
    ...
    if (elementoCPD && !bannerCriado) {
      ...
      sourceMobile.srcset =
        "https://www.nespresso.com/ecom/medias/sys_master/public/46587463204894/Main-Banner-Mobile-Aquisi-o.jpg?attachment=true&cimgnr=VysXz";

      // Source para desktop (padrão)
      const sourceDesktop = document.createElement("source");
      sourceDesktop.media = "(min-width: 769px)";
      sourceDesktop.srcset =
        "https://www.nespresso.com/ecom/medias/sys_master/public/46587462385694/Main-Banner-Desk-Aquisi-o.jpg?attachment=true&cimgnr=1EGoz";
