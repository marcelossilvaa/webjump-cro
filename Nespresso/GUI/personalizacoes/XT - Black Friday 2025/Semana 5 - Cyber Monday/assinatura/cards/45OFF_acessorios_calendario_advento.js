(function () {
  ...
  const CARDS_CONFIG = [
    ...
    {
      id: "black-friday-2025-calendarioAdvento",
      enabled: true,
      position: 5,
      targetCollections: [
        //Original
      ...
      variants: {
        ol: {
          banner:
            "https://www.nespresso.com/ecom/medias/sys_master/public/46770473140254/Card-PLP-OL-1.jpg?attachment=true&cimgnr=RTMZJ",
        ...
        vl: {
          banner:
            "https://www.nespresso.com/ecom/medias/sys_master/public/46770473205790/Card-PLP-VL-1-1-.jpg?attachment=true&cimgnr=zKbJi",
          ctaText: "ADICIONAR AO CARRINHO",
          ctaAction: "addToCart",
          ctaSKU: "146924",
          ctaQuantity: 1,
