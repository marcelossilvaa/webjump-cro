(function () {
  ...
  const renderOffersComponent = (container) => {
    ...
    if (dadosEntrega) {
      const communicationHTML = `<div style="padding:8px 0;text-align:center">
        <div style="display:inline-block;padding: 8px 12px;font-size: 14px;background-color: #FFF;border-radius: 6px;border: 1px solid #e6dddd;color: #000;">
