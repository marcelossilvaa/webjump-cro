(function () {
  if (window.ultimosDiasBFMinicart) {
    return;
  }
  ...
  window.ultimosDiasBFMinicart = "true";
  ...
  const capsuleGiftTiers = [
    {
      html: `<div style="padding:8px 0;text-align:center"><div style="display: flex;flex-direction: column;font-size: 14px;align-items: center;/* background-color: #912424; */border-radius: 6px;color: #912424;;"><span style="TEXT-TRANSFORM: uppercase;
"><strong>Últimas horas</strong> de CYBER MONDAY</span><strong style="font-size: 18px;background-color: #912424;;color: #FFF;border-radius: 30px;padding: 3px 10px;width: fit-content;">AS MELHORES OFERTAS DO ANO</strong></div></div>`
    },
  ];
...
"><strong>Últimas horas</strong> de CYBER MONDAY</span><strong style="font-size: 18px;background-color: #912424;;color: #FFF;border-radius: 30px;padding: 3px 10px;width: fit-content;">AS MELHORES OFERTAS DO ANO</strong></div></div>`
  ...
  const addAnimationStyles = () => {
    if (document.getElementById("comunicacao_ultimos_dias_minicart")) return;

    const styleEl = document.createElement("style");
    styleEl.id = "comunicacao_ultimos_dias_minicart";
    styleEl.textContent = `
  ...
  const createOffersComponent = () => {
    const existingComponent = document.getElementById(
      "comunicacao_dinamica_black_friday"
    );
    ...
    container.id = "comunicacao_dinamica_black_friday";
