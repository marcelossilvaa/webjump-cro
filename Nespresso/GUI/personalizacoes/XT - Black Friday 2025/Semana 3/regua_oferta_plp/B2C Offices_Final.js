(function () {
  ...
  .nespresso-banner-main strong { color: #47233A; }\
  ...
  .nespresso-progress-fill { position: absolute; left: 0; top: 0; height: 100%; background: #47233A; border-radius: 2px; transition: width 0.5s ease-out; }\
  ...
  .nespresso-progress-dot.completed { border-color: #47233A; color: #FFF; background-color: #47233A; }\
  ...
  .nespresso-minimized-tab { position: absolute; top: 0; left: 50%; transform: translateX(-50%); color: #fff; padding: 8px 20px; border-radius: 8px 8px 0 0; font-size: 18px; font-weight: 500; cursor: pointer; display: none; transition: all 0.2s ease; background-color: #47233A; text-align: center; }\
