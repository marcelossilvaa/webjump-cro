(function () {
  ...
  const CARDS_CONFIG = [
    ...
    {
      id: "black-friday-2025-assinatura-15off",
      enabled: true,
      position: 5,
      targetCollections: [
        //Original
      ...
      variants: {
        ol: {
          banner:
            "https://www.nespresso.com/ecom/medias/sys_master/public/46587471101982/432x692-3-primeiros-pedidos.jpg?attachment=true&cimgnr=GWhKE",
