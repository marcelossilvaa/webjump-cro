(function () {
  ...
  .nespresso-banner-main strong { color: #BE4191; }\
  ...
  .nespresso-progress-fill { position: absolute; left: 0; top: 0; height: 100%; background: #BE4191; border-radius: 2px; transition: width 0.5s ease-out; }\
  ...
  .nespresso-progress-dot.completed { border-color: #BE4191; color: #FFF; background-color: #BE4191; }\
  ...
  .nespresso-minimized-tab { position: absolute; top: 0; left: 50%; transform: translateX(-50%); color: #fff; padding: 8px 20px; border-radius: 8px 8px 0 0; font-size: 18px; font-weight: 500; cursor: pointer; display: none; transition: all 0.2s ease; background-color: #BE4191; text-align: center; }\
