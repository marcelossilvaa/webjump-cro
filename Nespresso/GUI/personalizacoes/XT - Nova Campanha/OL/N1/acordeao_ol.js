    ...
    ofertas: [
      {
        ...
        titulo: "Ganhe 10 cafés Colombia",
        alt: "10 cafés Colombia",
      },
      {
        quantidadeCafes: 100,
        imagem:
          "https://www.nespresso.com/ecom/medias/sys_master/public/45977916243998/Acorde-o-OL-N2.png?attachment=true&cimgnr=nZkf1",
        titulo: "Ganhe 1 Porta-Cápsulas Mini Display",
        alt: "1 Porta-Cápsulas Mini Display",
      },
      {
        quantidadeCafes: 150,
        imagem:
...
<br><br><strong>Para pedidos que contenham cápsulas da linha Original ou que incluam, de forma combinada, cápsulas das linhas Original e Vertuo:</strong>
<br><br>a. Compre a partir de 70 cápsulas (i) da linha Original Nespresso, ou (ii) de uma combinação das linhas Original e Vertuo Nespresso em um mesmo pedido, e ganhe um sleeve do café Master Origins Colombia para o sistema Nespresso Original Line.<br>b. Compre a partir de 100 cápsulas (i) da linha Original Nespresso, ou (ii) de uma combinação das linhas Original e Vertuo Nespresso em um mesmo pedido, e ganhe uma Xícara Vertuo Espresso Nespresso.<br>c. Compre a partir de 150 cápsulas (i) da linha Original Nespresso, ou (ii) de uma combinação das linhas Original e Vertuo Nespresso em um mesmo pedido, e ganhe um Porta Cápsulas Bonbonnière Nespresso.<br>d. Compre a partir de 200 cápsulas (i) da linha Original Nespresso, ou (ii) de uma combinação das linhas Original e Vertuo Nespresso em um mesmo pedido, e ganhe par de Xícaras Vertuo Espresso Nespresso.<br>e. Compre a partir de 250 cápsulas (i) da linha Original Nespresso, ou (ii) de uma combinação das linhas Original e Vertuo Nespresso em um mesmo pedido, e ganhe um par de Xícaras Vertuo Double Espresso Nespresso.<br><br>
Essa oferta é exclusiva para clientes selecionados Nespresso, sendo intransferível e não se aplica para pessoas jurídicas com histórico de compras de cápsulas da linha profissional, bem como para outros clientes portadores de CNPJ, não cumulativas com outras ofertas em andamento e limitada a um uso por CPF de registro na Nespresso.
