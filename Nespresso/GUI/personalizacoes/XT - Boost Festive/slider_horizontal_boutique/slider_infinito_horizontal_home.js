(function () {
  ...
  function sendGAEvent(label) {
    ...
    gtmDataObject.push({
      ...
      local_event_category: "slider-infinito-horizontal", //free to fill field, please use lower case
  ...
  const ELEMENT_SELECTOR = "nb-hero-banner"; // Seletor do elemento a ser buscado
  ...
  function createSlider() {
    ...
    const messages = [
      ...
      {
        text: "COMPRE NO SITE E RETIRE NA LOJA <strong>EM ATÉ 2H SEM PAGAR FRETE</strong>",
      ...
      {
        text: "*Encontre a boutique mais próxima",
        ...
        link: "https://www.nespresso.com/br/pt/localizador-lojas",
      },
    ];
  ...
  function insertSlider(element) {
    ...
    element.insertAdjacentHTML("beforebegin", sliderHTML);
    ...
    modalItems.forEach((item) => {
      item.addEventListener("click", function () {
        ...
        sendGAEvent("abriu_modal_slider_infinito");
    ...
    // Adiciona event listeners para links (elementos <a>)
    const linkItems = document.querySelectorAll("a.benefits-slider-item");
    linkItems.forEach((item) => {
      item.addEventListener("click", function (e) {
        // Verifica se o link contém o texto sobre encontrar boutique
        if (
          this.textContent.includes("Encontre a boutique mais próxima") ||
          this.textContent.includes("*Encontre a boutique mais próxima")
        ) {
          sendGAEvent("click_encontre_loja_slider_infinito");
        }
      });
    });
