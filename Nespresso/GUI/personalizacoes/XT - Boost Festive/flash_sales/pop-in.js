(function () {
  const cutoff = new Date("2025-12-31T00:00:00"); // Data limite
  ...
  function sendGAEvent(action, label) {
    ...
    gtmDataObject.push({
      ...
      local_event_category: "pop-in-cupom-flash-festive", //free to fill field, please use lower case
    ...
    document.body.insertAdjacentHTML(
      ...
      `<div id="custom-popin" style="display:none;">
        ...
        <div class="content" id="container_redirecionamento">
            <div class="title">GANHE<span style="font-weight: 700;"> +10% OFF</span></div>
            <div class="desc">
                NA COMPRA DE 200 CÁPSULAS.<br> USE O CUPOM: <span style="font-weight: 700;font-size: 18px;">PRESENTE10</span>
            </div>
        </div>
        <div class="image">
            <img src="https://www.nespresso.com/ecom/medias/sys_master/public/47127944593438/imagem-7-.jpg?attachment=true&cimgnr=QxZ3e" alt="Imagem 10% OFF em compras a partir de 200 cápsulas">
        </div>
      </div>`
    );
  ...
  function inicializarRedirecionamento() {
    ...
    elemento.addEventListener("click", function () {
      ...
      sendGAEvent("click", "click_pop_in");
  ...
  function fecharPopin() {
    sendGAEvent("click", "close_pop_in");
    try {
