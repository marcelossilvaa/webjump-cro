(function () {
  ...
  const giftTiers = [
    ...
    {
      threshold: 400,
      gift: "2 Canecas Térmicas M Orange ou 4 Copos Barista Small + Porta Capsulas Lume Mia ",
      shortName: "2 Canecas Térmicas ou 4 Copos Barista + Porta Cápsulas",
      displayName: "2 CANECAS TÉRMICAS ou 4 COPOS + PORTA CÁPSULAS",
      imageUrl:
        "https://www.nespresso.com/ecom/medias/sys_master/public/46767788163102/200x200-kit-2-mug-orange.png?attachment=true&cimgnr=V5Dux", // Substitua pela URL da imagem real
    },
    {
      threshold: 500,
