(function () {
  ...
  const giftTiers = [
    ...
    {
      threshold: 150,
      gift: "1 Biscoito Lemon + 1 Copo",
      shortName: "Bis. + Copo",
      image:
        "https://www.nespresso.com/ecom/medias/sys_master/public/44749037109278/Stick-banner-400x400-N3.png?attachment=true&cimgnr=Zwbz2",
    },
    {
      threshold: 200,
      ...
      nextTierInfoHtml =
        ...
        (isMobile
          ? `<img src="` +
            ...
            ` alt="` +
            tierInfo.nextTier.gift +
            ` style="width:38px; height:38px; border: 2px solid #b8860b; border-radius:50%;">`
          : ``) +
        `
                    </div>
                  </div>
