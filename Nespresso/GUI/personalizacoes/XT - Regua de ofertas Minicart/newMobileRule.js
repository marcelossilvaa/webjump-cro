(function () {
  ...
  const renderOffersComponent = (container, totalCapsules) => {
    ...
    const headerHtml = `
        <div class="${
          isMobile ? "nespresso-mobile-header" : ""
        }" style="text-align: center; margin-bottom: ${
      isMobile ? "0" : "8px"
    };">
          ...
          ${giftTiers
            .map((tier, index) => {
              ...
              <div class="nespresso-tooltip" style="flex: 1; text-align: center; position: relative; min-width: 40px;">
                <div class="${justAchieved ? "nespresso-gift-achieved" : ""} ${
                ...
                <p style="font-size: 10px; line-height: 1.1; color: ${
                  ...
                  ${tier.shortName}<br>
                  <span style="font-weight: ${isCurrent ? "600" : "400"};">${
                tier.threshold
              }</span>
                </p>
              </div>
    ...
    if (tierInfo.nextTier) {
      nextTierInfoHtml = `
          <div style="margin-top: ${isMobile ? "8px" : "12px"};">
            <div style="display: flex; align-items: center; justify-content: space-between; background-color: rgb(249, 249, 249); border-radius: 6px; padding: ${
              ...
              <div style="flex: 1; display:flex; align-items:center;justify-content:space-evenly;">
                <p style="font-size: 12px; color: #666; margin: 0 0 2px 0;">
                  ...
                  } cápsulas</strong> para ganhar: <span style="font-size: 12px; color: #b8860b; font-weight: 500; margin: 0;">${
        tierInfo.nextTier.gift
      }</span>
                </p>
                ${
                  isMobile
                    ? `<img src="${tierInfo.nextTier.image} alt="${tierInfo.nextTier.gift} style="width:38px; height:38px; border: 2px solid #b8860b; border-radius:50%;">`
                    : ``
                }
              </div>
            </div>
