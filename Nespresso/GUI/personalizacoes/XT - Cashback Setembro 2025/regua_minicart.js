      ...
      giftTiers
        .map((tier, index) => {
          ...
          return (
            ...
            `"
                         style="width: 60px; height: 60px; margin: 0 auto 4px auto; border-radius: 6px; display: flex; align-items: center; justify-content: center; 
                         background-color: ` +
            ...
            `;
                      ...
                      <p style="text-align: center; font-weight: 700; font-size: 12px; width: 100%; height: 100%; display: flex; justify-content: center; align-items: center; flex-direction: column; margin: 0; color: ` +
            (achieved ? "#000" : "#000") +
            `;">
                        ` +
            tier.shortName +
            `<br><span style="font-size: 10px; font-weight: 500;">de créditos</span>
                      </p>
                    </div>
