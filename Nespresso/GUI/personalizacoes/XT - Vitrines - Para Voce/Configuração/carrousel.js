(function () {
  ...
  // Função para inicializar ou atualizar a navegação do carousel
  function initOrUpdateCarouselNavigation(carouselElement) {
    ...
    function getVisibleItemCount() {
      const containerWidth = carouselElement.querySelector(
    ...
    function updateCarouselPosition() {
      itemWidth = items[0].offsetWidth; // Atualizar a largura em cada chamada
      ...
      updatedNextButton.disabled = currentIndex >= items.length - visibleCount;
