(function () {
  ...
  const CARDS_CONFIG = [
    ...
    //Mes do consumidor
    {
      id: "mes_consumidor_oferta_170off",
      enabled: true,
      position: 5,
      targetCollections: [
        //Original
      ...
      variants: {
        ol: {
          banner:
            "https://www.nespresso.com/ecom/medias/sys_master/public/48678644842526/Card-PLP.jpg?attachment=true&cimgnr=F8SUy",
        },
        vl: {
          banner:
            "https://www.nespresso.com/ecom/medias/sys_master/public/48678644842526/Card-PLP.jpg?attachment=true&cimgnr=F8SUy",
    ...
    {
      id: "mes_consumidor_acessorios_desconto",
      enabled: true,
      position: 5,
      targetCollections: [
        //Original
      ...
      variants: {
        ol: {
          banner:
            "https://www.nespresso.com/ecom/medias/sys_master/public/48681080356894/Cards-PLP-7-.jpg?attachment=true&cimgnr=oZwRU",
          ctaText: "COMPRE AGORA",
