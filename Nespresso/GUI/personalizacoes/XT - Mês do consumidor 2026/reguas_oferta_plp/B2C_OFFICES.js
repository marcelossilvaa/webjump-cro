(function () {
  ...
  const MOBILE_TEXT = "OFERTA PROGRESSIVA <strong>MÊS DO CONSUMIDOR</strong>";
      ...
      <div class="nespresso-welcome-offer-modal-container">\
        ...
        <div class="nespresso-welcome-offer-modal-content">\
          <div class="nespresso-welcome-offer-modal-termos">\
            ...
            <strong>OFERTA MÊS DO CONSUMIDOR</strong><br><br>\
            <p>As ofertas referentes ao Mês do Consumidor Nespresso, especificadas nos itens abaixo, são válidas de 02/03/2026 às 09h a 31/03/2026, apenas para pessoas físicas portadoras de CPF e clientes classificados na categoria B2C Offices (pessoas jurídicas com consumo exclusivo de cápsulas da linha doméstica), não se aplicando para pessoas jurídicas com histórico de compras de cápsulas da linha profissional, bem como para outros clientes portadores de CNPJ, não cumulativas com outras ofertas em andamento e limitadas a um uso por CPF de registro na Nespresso. Todos os produtos estão sujeitos à disponibilidade de estoque e as ofertas estão sujeitas a alterações sem aviso prévio.</p><br><br>\
            <p>a. Na compra a partir de 400 (quatrocentas) cápsulas, durante o período supramencionado, o consumidor ganhará um desconto fixo no valor de R$ 250,00 (duzentos e cinquenta reais), concedido apenas em pedidos que contenham cápsulas da linha Original e/ou Vertuo. Oferta disponível para todos os canais oficiais Nespresso: Boutiques Nespresso, telefone 0800 7777 737, WhatsApp (11) 95578-4670, site www.nespresso.com ou aplicativos para iPhone, iPad e Android.\
            <p>b. Na compra a partir de 250 (duzentas e cinquenta) a 399 (trezentas e noventa e nove) cápsulas, durante o período supramencionado, o consumidor ganhará um desconto fixo no valor de R$ 170,00 (cento e setenta reais), concedido apenas em pedidos que contenham cápsulas da linha Original e/ou Vertuo. Oferta disponível para todos os canais oficiais Nespresso: Boutiques Nespresso, telefone 0800 7777 737, WhatsApp (11) 95578-4670, site www.nespresso.com ou aplicativos para iPhone, iPad e Android.\
            <p>c. Na compra a partir de 200 (duzentas) a 249 (duzentas e quarenta e nove) cápsulas, durante o período supramencionado, o consumidor ganhará um desconto fixo no valor de R$ 120,00 (cento e vinte reais), concedido apenas em pedidos que contenham cápsulas da linha Original e/ou Vertuo. Oferta disponível para todos os canais oficiais Nespresso: Boutiques Nespresso, telefone 0800 7777 737, WhatsApp (11) 95578-4670, site www.nespresso.com ou aplicativos para iPhone, iPad e Android.</p>\
            <p>d. Na compra a partir de 150 (cento e cinquenta) a 199 (cento e noventa e nove) cápsulas, durante o período supramencionado, o consumidor ganhará um desconto fixo no valor de R$ 80,00 (oitenta reais), concedido apenas em pedidos que contenham cápsulas da linha Original e/ou Vertuo. Oferta disponível para todos os canais oficiais Nespresso: Boutiques Nespresso, telefone 0800 7777 737, WhatsApp (11) 95578-4670, site www.nespresso.com ou aplicativos para iPhone, iPad e Android.</p>\
            <p>e. Na compra a partir de 100 (cem) a 149 (cento e quarenta e nove) cápsulas, durante o período supramencionado, o consumidor ganhará um desconto fixo no valor de R$ 50,00 (cinquenta reais), concedido apenas em pedidos que contenham cápsulas da linha Original e/ou Vertuo. Oferta disponível para todos os canais oficiais Nespresso: Boutiques Nespresso, telefone 0800 7777 737, WhatsApp (11) 95578-4670, site www.nespresso.com ou aplicativos para iPhone, iPad e Android.</p><br><br>\
            <p>Na compra de qualquer oferta de cafés do Mês do Consumidor Nespresso, realizada através do aplicativo Nespresso Store exclusivamente às terças-feiras (das 09h de terça às 09h de quarta), durante o período do Mês do Consumidor Nespresso (02/03/2026 às 09h a 31/03/2026), o consumidor ganhará um desconto adicional de 5% (cinco por cento), aplicado no valor final do pedido. Oferta disponível no aplicativo Nespresso Store para iPhone, iPad e Android.</p>\
            <p>Durante o período da Campanha de Mês do Consumidor, de 02/03/2026 às 09h a 31/03/2026, os pedidos a partir de R$100,00 poderão ser parcelados em até 10x sem juros, sendo o número de parcelas limitado de acordo com o valor do pedido, respeitando o valor mínimo de R$50,00 por parcela, e terão entrega gratuita (frete grátis) para o modo de entrega padrão ou ‘standard’, para compras com no mínimo 70 cápsulas. Verifique o prazo de entrega para sua localidade ao escolher o modo de entrega antes da finalização de seu pedido. O modo de entrega Boutique Clique &amp; Retire (retirada em loja em todas as Boutiques Nespresso), será válido na compra de cápsulas, máquinas e acessórios. O prazo para retirada é de 1(um) dia, ou seja, no dia seguinte da compra, de acordo com a disponibilidade de estoque da Boutique Nespresso selecionada.</p><br>\
            <p>A Nespresso se reserva o direito, a seu critério exclusivo, de desqualificar qualquer indivíduo que interferir com o funcionamento das ofertas, seja ao criar várias contas, utilizar várias identidades ou agir de qualquer outra forma que seja considerada pela Nespresso como uma violação dos Termos e Condições, ou de alguma outra forma prejudicial.</p><br>\
            <p>Se você tiver consentido, no momento do cadastro, com o uso dos seus dados de contato e interações para receber comunicações de marketing da Nespresso, saiba que seu consentimento para este fim é voluntário e você é livre para retirá-lo a qualquer momento. Mais informações disponíveis na Política de Privacidade da Nespresso.</p><br><br>\
            <p>Em caso de dúvidas ou necessidade de informações adicionais, entre em contato com um de nossos Especialistas de Café pelo telefone gratuito 0800 7777 737 (segunda a sábado, das 6h às 22h).</p>\
            </div>\
        </div>\
      </div>';
  ...
  .nespresso-banner-main strong { color: #000; }\
  ...
  .nespresso-progress-fill { position: absolute; left: 0; top: 0; height: 100%; background: #CE4501; border-radius: 2px; transition: width 0.5s ease-out; }\
  ...
  .nespresso-progress-dot.completed { border-color: #CE4501; color: #FFF; background-color: #CE4501; }\
  ...
  .nespresso-minimized-tab { position: absolute; top: 0; left: 50%; transform: translateX(-50%); color: #000; padding: 8px 20px; border-radius: 8px 8px 0 0; font-size: 18px; font-weight: 500; cursor: pointer; display: none; transition: all 0.2s ease; background-color: #F3B663; text-align: center; }\
  .nespresso-minimized-tab strong { color: #000; }\
          ...
          <div class="nespresso-banner-left">\
            <div class="nespresso-banner-text">\
              <p class="nespresso-banner-title only-desktop">\
                OFERTA PROGRESSIVA <br><strong>MÊS DO CONSUMIDOR</strong><br>\
              </p>' +
      mobileTextBlock +
  ...
  // SKUs de kits que não devem ser contabilizados
  const excludedBundledSKUs = [
    "164290",
    "164288",
    "164291",
    "164289",
      ...
      for (const item of cartItems) {
        try {
          ...
          if (isCapsule(product)) {
            if (product.bundled) {
              if (
                !excludedBundledSKUs.some(function (sku) {
                  return item.productId.includes(sku);
                })
              ) {
