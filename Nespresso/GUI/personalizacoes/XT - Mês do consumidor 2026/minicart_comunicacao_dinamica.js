(function () {
  ...
  const capsuleGiftTiers = [
    {
      html: '<div style="padding:8px 0;text-align:center">\
          <div style="display:inline-block;padding:8px 12px; font-size: 14px;background-color: #F3B663;border-radius: 6px; color:#000;">\
          <strong style="font-size: 18px;">GANHE ATÉ R$ 170 OFF</strong>\
          <br>\
  ...
  const machineGiftTiers = [
    {
      html: '<div style="padding:8px 0;text-align:center">\
          <div style="display:inline-block;padding:8px 12px; font-size: 16px;background-color: #F3B663;border-radius: 6px; color:#000;">\
          <span>Máquinas com até </span>\
            <strong> 45% OFF + R$ 150 em cafés*</strong>\
          </div>\
          <br>\
  ...
  const accessoryGiftTiers = [
    {
      html: '<div style="padding:8px 0;text-align:center">\
          <div style="display:inline-block;padding:8px 12px; font-size: 14px;background-color: #F3B663;border-radius: 6px; color:#000;">\
          <strong style="font-size: 16px;">GANHE ATÉ 30% OFF</strong>\
          <br>\
