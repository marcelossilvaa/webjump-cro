(function () {
  ...
  const NespressoBanner = {
    ...
    defaultConfig: {
      targetSelector: "div[id*='Shopping-Bag-Top-Banner']", // Seletor onde inserir o componente
      ...
      coupons: [
        {
          label:
            "<span class='bold-text-offer'>Ganhe 10% OFF</span><br>na compra de 70 Cápsulas",
          code: "CAFEVL10",
        },
        {
          label:
...
a. Na compra a partir de 70 cápsulas, durante o período supramencionado,
o consumidor ganhará 10% de desconto, concedido apenas em pedidos
que contenham cápsulas exclusivamente da linha Vertuo. Para ativar o
desconto, o cliente deve inserir o código CAFEVL10 no campo Código
Promocional disponível na etapa carrinho, ou solicitar o desconto nas
Boutiques. Essa oferta é exclusiva para clientes selecionados
...
Android. <br><br>
b. Na compra a partir de 120 cápsulas, durante o período
...
4670, site www.Nespresso.com ou aplicativos para iPhone, iPad e
Android. <br><br>
c. Na compra a partir de 170 cápsulas, durante o período
    ...
    getStyles: function () {
      return `
        <style id="nespresso-banner-styles">
          .nb-informative-stripe, div[id*='Shopping-Bag-Top-Banner'] {
            display:none;
          }
