(function () {
    ...
    async function healthCheck() {
      try {
        ...
        if (!window.CartManager || typeof window.CartManager.updateItem !== "function") {
          console.warn("CartManager não está disponível - experiência não será ativada");
          return false;
        }
    ...
    async function initializeExperiment() {
        ...
        try {
          ...
          while (
            ...
            try {
              ...
              if (!window.CartManager || typeof window.CartManager.updateItem !== "function") {
                throw new Error("CartManager não está disponível para adicionar ao carrinho");
              }

              const operationPromise = window.CartManager.updateItem(
                productSku,
                capsulesQuantity,
                null,
                null,
      ...
      //função para executar operação real
