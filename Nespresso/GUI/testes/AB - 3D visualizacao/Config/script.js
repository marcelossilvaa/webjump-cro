(function () {
  function initNewVisualization() {
    const iframeURL =
      "https://view.ocavu.com/nespresso/pop-color-configurator?configurator_Descriptions=cup";
    const modalHTML =
      `
  ...
  `;
    ...
    const ctaElement = document.querySelector("nb-cta-3d");
    if (ctaElement) {
  ...
  if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", initNewVisualization);
  } else {
