(function () {
  ...
  function createSignatureCopy(productElement) {
    ...
    if (priceElement) {
      ...
      // Cachear o novo elemento de assinatura
      const signatureElement = priceDiv.nextElementSibling;
      if (
        signatureElement &&
        signatureElement.classList.contains("assinaturaInfoPLP")
      ) {
...
<path d="M6.51667 7.57578H0V5.88411H6.51667L6.5 0H8.38333V5.88411H14.5V7.57578H8.38333V14H6.51667V7.57578Z" fill="#347259"/>
    ...
    // Função de fallback usando o botão original - OTIMIZADA
