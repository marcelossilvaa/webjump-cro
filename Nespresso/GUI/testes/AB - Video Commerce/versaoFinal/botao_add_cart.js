(function () {
  "use strict";
  if (window.botaoAddCartVideoCommerce) return;
  window.botaoAddCartVideoCommerce = true;
  ...
  const selector = "#block-8834237912565";
  ...
  function sendGAEvent(label) {
    ...
    gtmDataObject.push({
      ...
      local_event_category: "video_commerce_stream_shop", //free to fill field, please use lower case
  ...
  let cafes = {
    "Chocolate amargo com nibs de cacau": {
      sku: "145411",
      quantity: 1,
    },
    ...
    "Calendário do Advento Original": {
      sku: "146922",
      quantity: 1,
    },
    "Bolas de Natal Festive": {
      sku: "145643",
      quantity: 1,
    },
  };
  ...
  const intervalId = setInterval(function () {
    ...
    if (element) {
      ...
      element.insertAdjacentHTML(
        "afterend",
        `<liveshop-ads-carousel-v2 height="500px" slugs-video="Er0L3iKr,plFrhinw,dsxoRTE4,NrWWiYz9,TQnXTkMR,bTM4ZMgs"></liveshop-ads-carousel-v2>`
      );
      ...
      function addButtonToProduct(product) {
        ...
        const productNameText = productName
          ...
          : null;
        const productData = productNameText ? cafes[productNameText] : null;
        ...
        if (sku && productInfo) {
          ...
          button.setAttribute("data-product-name", productNameText || "");
            ...
            try {
              ...
              const checkCartInterval = setInterval(async () => {
                ...
                if (inCartSkus.has(sku)) {
                  ...
                  // Envia evento para o GA com nome do produto e quantidade
                  const productName = button.getAttribute("data-product-name");

                  sendGAEvent(`add-to-cart_` + productName);
