(function () {
  ...
  cv-search-bar:has(input[class*='searchbox']:focus):not(:has(div[role='dialog'][class*='dropdown'])) .containerRecomendacoesBusca{
      display:flex;
}
  ...
  let recomendacoesHTML = `<div role="dialog" class="containerRecomendacoesBusca">
