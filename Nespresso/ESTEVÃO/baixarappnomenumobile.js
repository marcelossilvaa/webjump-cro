(function () {
  ...
  function getStyles() {
    return [
      '.HeaderNavigationBarItem__app-incentive {',
      '  display: block;',
      '  font-size: 11px;',
      '  color: #c59b6d;',
      '  font-weight: 600;',
      ...
      '  line-height: 1.2;',
      '}',
      '.HeaderNavigationBarItem__app-icon {',
      '  display: block;',
      '  width: 25px;',
      '  margin: 0 13px;',
      '  flex-shrink: 0;',
      '}',
      '.HeaderNavigationBarItem__app-icon svg {',
      '  width: 25px;',
      '  height: 25px;',
      '  fill: #000;',
      ...
      '  align-items: center;',
      '}',
      '[data-baixar-app-added] .HeaderNavigationBarItem__title-container {',
      '  display: flex;',
  ...
  function createAppMenuItem() {
    ...
    titleContainer.className = 'HeaderNavigationBarItem__title-container';

    const titleDiv = document.createElement('div');
    titleDiv.className = 'HeaderNavigationBarItem__title';
