(function (window, document) {
    ...
    var ModuloAssinatura = (function () {
        /* ===================== CONFIGURAÇÕES ===================== */
        var CONFIGURACAO = {
            descontoPercentual: 0.15, // 15% de desconto
        ...
        var TEXTOS = {
            ...
            rotuloTotalAssinatura: "<strong><a href='https://www.nespresso.com/br/pt/pedido-automatico' style='color: #fff;text-decoration: underline;' id='link-assinatura-title'>Assinatura Nespresso:</a></strong> 15% OFF nas 3 primeiras entregas*<br> <span style='font-size:8px;'>*Exclusivo para Novos Assinantes</span>",
            prefixoEconomia: "",
        };
        ...
        function garantirCSS() {
            ...
            var css =
                ...
                "." +
                CLASSES.barraTotal +
                "{display:flex;align-items:center;justify-content:space-between;gap:6px;margin:10px 0 8px;" +
                "padding:0 10px;height:54px;border-radius:14px;background:" +
                ...
                CORES.verdeFlag +
                ";color:#fff;font-size:8px;font-weight:700;display:flex;align-items:center;justify-content:center;line-height:30px;text-align:center}";
            css +=
        ...
        function inserirOuAtualizarBarraTotal(raiz) {
            ...
            // 3) Bind do clique no link #link-assinatura-title -> dispara local_event no GTM
            var linkAssinaturaTitle = barra.querySelector('#link-assinatura-title');
            if (linkAssinaturaTitle && !linkAssinaturaTitle.getAttribute("data-wj-title-bound")) {
                linkAssinaturaTitle.setAttribute("data-wj-title-bound", "1");
                linkAssinaturaTitle.addEventListener(
                    "click",
                    function () {
                        try {
                            window.gtmDataObject = window.gtmDataObject || [];
                            window.gtmDataObject.push({
                                ...
                                event_raised_by: "br",
                                local_event_category: "user engagement",
                                local_event_action: "assinatura_title_link_click",
                                local_event_label: "xt_adobe_target_assinatura_title_link",
                            });
                        } catch (e) { }
                    },
                    false
