(function () {
    ...
    if (window.cupomCheckoutFlashSalesVertuo) {
        return;
    }
    window.cupomCheckoutFlashSalesVertuo = true;
    ...
    const NespressoBanner = {
        ...
        defaultConfig: {
            ...
            coupons: [
                {
                    label: "<span class='bold-text-offer'>GANHE +10% OFF</span><br>na compra de 70 Capsulas Vertuo",
                    code: "VERTUO10",
                },
                {
                    label: "<span class='bold-text-offer'>GANHE +15% OFF</span><br>na compra de 170 Capsulas Vertuo",
                    code: "CAFEOFF15",
                },
            ],
            texts: {
        ...
        // CSS do componente
        getStyles: function () {
            return '<style id="nespresso-banner-styles-checkout-vertuo">' +
        ...
        insertComponent: function (config) {
            ...
            this.waitForElement(
                ...
                if (!document.getElementById("nespresso-banner-styles-checkout-vertuo")) {
                ...
                console.log("[Cupom Checkout Vertuo] Componente inserido com sucesso");
            }).catch(function (error) {
                console.error("[Cupom Checkout Vertuo] Falha ao inserir componente:", error.message);
            });
        },
        ...
        remove: function () {
            ...
            var existingStyles = document.getElementById("nespresso-banner-styles-checkout-vertuo");
