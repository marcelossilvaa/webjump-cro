(function () {
    ...
    if (window.cupomCheckoutFlashSalesAberto) {
        return;
    }
    window.cupomCheckoutFlashSalesAberto = true;
    ...
    const NespressoBanner = {
        ...
        // CSS do componente
        getStyles: function () {
            return '<style id="nespresso-banner-styles-checkout-aberto">' +
        ...
        insertComponent: function (config) {
            ...
            this.waitForElement(
                ...
                if (!document.getElementById("nespresso-banner-styles-checkout-aberto")) {
                ...
                console.log("[Cupom Checkout Aberto] Componente inserido com sucesso");
            }).catch(function (error) {
                console.error("[Cupom Checkout Aberto] Falha ao inserir componente:", error.message);
            });
        },
        ...
        remove: function () {
            ...
            var existingStyles = document.getElementById("nespresso-banner-styles-checkout-aberto");
