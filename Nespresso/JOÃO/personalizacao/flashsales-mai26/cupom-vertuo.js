(function () {
    ...
    if (window.cupomFlashSalesVertuo) {
        return;
    }
    window.cupomFlashSalesVertuo = true;
    ...
    const NespressoBanner = {
        ...
        // CSS do componente
        getStyles: function () {
            return '<style id="nespresso-banner-styles-vertuo">' +
        ...
        insertComponent: function (config) {
            ...
            this.waitForElement(
                ...
                if (!document.getElementById("nespresso-banner-styles-vertuo")) {
                ...
                console.log("[Cupom Vertuo] Componente inserido com sucesso");
            }).catch(function (error) {
                console.error("[Cupom Vertuo] Falha ao inserir componente:", error.message);
            });
        },
        ...
        remove: function () {
            ...
            var existingStyles = document.getElementById("nespresso-banner-styles-vertuo");
