(function () {
    ...
    function injectStyles() {
        ...
        style.textContent =
            ...
            '  font-family: "DM Sans", "NespressoLucas", "Helvetica Neue", Arial, sans-serif;' +
            '}' +
            '.flash-modal {' +
            '  background-color: #971B2F; border-radius: 20px;' +
            '  padding: 50px 40px 40px; max-width: 480px; width: 90%;' +
            ...
            '  .flash-coupon-card { flex-direction: column; align-items: flex-start; gap: 12px; padding: 20px 22px; }' +
            '  .flash-coupon-action { align-items: flex-start; }' +
