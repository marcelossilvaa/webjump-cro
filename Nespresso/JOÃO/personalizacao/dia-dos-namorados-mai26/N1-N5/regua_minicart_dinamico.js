(function () {
  ...
  const giftTiersOL = [
    {
      threshold: 70,
      gift: "10 Cafés Arpeggio",
      shortName: "10 cafés Arpeggio",
      displayName: "GANHE 10 CAFÉS ARPEGGIO",
      imageUrl:
    ...
    {
      threshold: 100,
      gift: "1 Par de Toalhas Barista",
      shortName: "1 Par de Toalhas Barista",
      displayName: "GANHE 1 PAR DE TOALHAS BARISTA",
      imageUrl:
  ...
  const giftTiersVL = [
    {
      threshold: 50,
      gift: "10 Cafés Altissio",
      shortName: "10 cafés Altissio",
      displayName: "GANHE 10 CAFÉS ALTISSIO",
      imageUrl:
        "https://www.nespresso.com/ecom/medias/sys_master/public/51150903410718/Dinamic-Banner-N1-VL.jpg?attachment=true&cimgnr=JnvBC",
    },
    {
      threshold: 70,
      gift: "1 Par de Toalhas Barista",
