<script>
  ...
  if (window.cupomFlashSalesFestive) {
            return;
        }
  window.cupomFlashSalesFestive = true;
  ...
  defaultConfig: {
    targetSelector: "nb-plp-coffee-xf-cards", // Seletor onde inserir o componente
  insertPosition: "before", // "replace", "prepend", "append", "before", "after"
  ...
  coupons: [{
    label: "<span class='bold-text-offer'>GANHE +10% OFF</span><br>na compra a partir de 200 Cápsulas",
      code: "PRESENTE10",
                }, ],
      texts: {
