(function () {
  ...
  const PRODUCT_MAP = [
    ...
    { pattern: 'vermelho-pimenta', url: 'https://nest-mv.zap.works/?key=nestle/vertuo-pop-red' },
    { pattern: 'amarelo-manga', url: 'https://nest-mv.zap.works/?key=nestle/vertuo-pop-yellow' },
    { pattern: 'verde-acqua', url: 'https://nest-mv.zap.works/?key=nestle/vertuo-pop-aqua' },
    { pattern: 'azul-pacifico', url: 'https://nest-mv.zap.works/?key=nestle/vertuo-pop-blue' },
    { pattern: 'branco-coco', url: 'https://nest-mv.zap.works/?key=nestle/vertuo-pop-white' },
    { pattern: 'pop-preta', url: 'https://nest-mv.zap.works/?key=nestle/vertuo-pop-black' },
    {
      pattern: 'pop-preto-classico',
      url: 'https://nest-mv.zap.works/?key=nestle/vertuo-pop-black',
    },

    // Vertuo Pop - Novas cores
    {
      pattern: 'pop-lilas',
      url: 'https://nest-mv.zap.works/?key=nespresso/vertuo-pop-c-range-lilac-nespresso',
    },
    {
      pattern: 'pop-pistache',
      url: 'https://nest-mv.zap.works/?key=nespresso/vertuo-pop-pistachio',
    },
    {
      pattern: 'pop-amarelo-summer',
      url: 'https://nest-mv.zap.works/?key=nespresso/vertuo-pop-pastel-yellow',
    },
    {
      pattern: 'pop-rosa-candy',
      url: 'https://nest-mv.zap.works/?key=nespresso/vertuo-pop-candy-pink-nespresso',
    },

    // Vertuo Next - Cherry Red
    {
      pattern: 'next-vermelho-cereja',
      url: 'https://nest-mv.zap.works/?key=nespresso/vertuo_next_cherry_red_c_range',
    },

    // Vertuo Next - Dark Chrome
    {
      pattern: 'next-dark-chrome',
      url: 'https://nest-mv.zap.works/?key=nespresso/nespresso_vertuo_next_deluxe_gcv1_chrome_nespresso',
    },

    // Professional Machines
    { pattern: 'aguila-220', url: 'https://nest-mv.zap.works/?key=nespresso/aguila_220_b2b' },
    { pattern: 'momento-100', url: 'https://nest-mv.zap.works/?key=nespresso/momento_100_b2b' },
    { pattern: 'momento-milk', url: 'https://nest-mv.zap.works/?key=nespresso/momento_120_b2b' },
    { pattern: 'zenius', url: 'https://nest-mv.zap.works/?key=nespresso/zenius_b2b' },
    {
      pattern: 'maquina-cafe-para-empresas-momento-100-110v',
      url: 'https://nest-mv.zap.works/?key=nespresso/momento_100_b2b',
    },
    {
      pattern: 'maquina-cafe-para-empresas-momento-milk',
      url: 'https://nest-mv.zap.works/?key=nespresso/momento_120_b2b',
    },
    {
      pattern: 'maquina-pro-de-cafe-zenius',
      url: 'https://nest-mv.zap.works/?key=nespresso/zenius_b2b',
    },
    {
      pattern: 'pro-coffee-machine-zenius',
      url: 'https://nest-mv.zap.works/?key=nespresso/zenius_b2b',
    },
  ];
