(function () {
  ...
  if (window.ocultarTopMessageBannerMobBoostSetembro) {
    return;
  }
  window.ocultarTopMessageBannerMobBoostSetembro = "true";

  const STYLE_ID = "boost-setembro-hide-top-message-banner-mob";
