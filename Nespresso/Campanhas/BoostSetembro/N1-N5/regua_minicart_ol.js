(function () {
  if (window.boostSetembroProgressBar) {
    return;
  }
  ...
  window.boostSetembroProgressBar = "true";
  ...
  // TODO playbook: paleta, brindes e imagens oficiais. Paleta provisoria #1a1a1a / #ffffff / #666666
  const giftTiers = [
    {
      threshold: 70,
      gift: "1 Brinde N1",
      shortName: "1 Brinde N1",
      displayName: "GANHE 1 BRINDE N1",
      imageUrl:
        "TODO_URL_N1_OL",
    },
    {
      threshold: 100,
      gift: "1 Brinde N2",
      shortName: "1 Brinde N2",
      displayName: "GANHE 1 BRINDE N2",
      imageUrl:
        "TODO_URL_N2",
    },
    {
      threshold: 150,
      gift: "1 Brinde N3",
      shortName: "1 Brinde N3",
      displayName: "GANHE 1 BRINDE N3",
      imageUrl:
        "TODO_URL_N3",
    },
    {
      threshold: 200,
      gift: "1 Brinde N4",
      shortName: "1 Brinde N4",
      displayName: "GANHE 1 BRINDE N4",
      imageUrl:
        "TODO_URL_N4",
    },
    {
      threshold: 270,
      gift: "1 Brinde N5",
      shortName: "1 Brinde N5",
      displayName: "GANHE 1 BRINDE N5",
      imageUrl:
        "TODO_URL_N5",
    }
  ];
  ...
  const createOffersComponent = () => {
    ...
    container.id = "nespresso-boost-setembro-offers";
  ...
  const renderOffersComponent = (container, totalCapsules) => {
      ...
      if (tierInfo.nextTier) {
        mobileHtml =
          ...
          <div style="display: flex; align-items: center; justify-content: space-between; padding: 0px 25px; gap: 12px;">
            <div style="flex: 1; text-align: left;">
              <p style="font-size: 13px; color: #1a1a1a; margin: 0 0 6px 0; font-weight: 600;">
                Adicione mais <span style="background-color: #1a1a1a; color: #ffffff; padding: 2px 6px; border-radius: 4px; font-weight: 700;">` +
          tierInfo.capsulesToNextTier +
          ` cápsulas</span>
              </p>
              <p style="font-size: 12px; color: #1a1a1a; margin: 0; font-weight: 700;">
                e ganhe: ` +
          ...
          `
            ...
            <div style="flex-shrink: 0;">
              <div style="width: 70px; height: 70px; border-radius: 50%; border: 3px solid #1a1a1a; overflow: hidden; background-color: #fff;">
                <img src="` +
        ...
        mobileHtml =
          ...
          <div style="display: flex; align-items: center; justify-content: space-between; padding: 12px 8px; gap: 12px;">
            <div style="flex: 1; text-align: left;">
              <p style="font-size: 13px; color: #1a1a1a; margin: 0 0 4px 0; font-weight: 600;">
              Parabéns!
              </p>
              <p style="font-size: 12px; color: #1a1a1a; margin: 0; font-weight: 700;">
    ...
    if (tierInfo.nextTier) {
                ...
                <div style="margin-top: 12px;">
                  <div style="display: flex; align-items: center; justify-content: space-between; border-radius: 6px; padding: 2px 8px;">
                    <div style="flex: 1; display:flex; align-items:center;justify-content:space-evenly;">
                      <p style="font-size: 12px; color: #1a1a1a; margin: 0 0 2px 0;text-align:center">
                        <strong>Adicione mais <span style="background-color: #1a1a1a; color: #ffffff; padding: 2px 4px;border-radius: 4px;">` +
        tierInfo.capsulesToNextTier +
        ` cápsulas</span></strong> para ganhar: <span style="font-size: 13px; color: #1a1a1a; font-weight: 700; margin: 0;">` +
        tierInfo.nextTier.gift +
        `</span>
                      </p>
                    </div>
      ...
      nextTierInfoHtml = `
                <div style="text-align: center; padding: 8px 0; margin-top: 8px;">
                  <span style="font-size: 11px; color: #1a1a1a; font-weight: 500;">
    ...
    // html += `<span class="credito_span_regua_oferta" style="display: block;text-align: center;font-size: 11px;color: #1a1a1a;margin-top: 6px;">*Crédito disponível em até 48h</span>`;
