(function () {
  if (window.acordeaoBoostSetembro || window.innerWidth > 600) {
    return;
  }
  window.acordeaoBoostSetembro = "true";
  ...
  const CAMPANHA_CONFIG = {
    // TODO playbook: paleta, brindes, imagens e T&C oficiais.
    // Paleta provisoria (escala de cinza) — nao usar em producao.
    // Principal #1a1a1a | Secundaria #ffffff | Terciaria #ffffff | Quaternaria #666666
...
Na compra a partir de 270 cápsulas, durante o período supramencionado, o consumidor ganhará Brinde N5 Nespresso, concedido apenas em pedidos que (i) contenham cápsulas exclusivamente da linha Original ou, (ii) que contenham, de forma combinada, cápsulas das linhas Original e Vertuo dentro de um mesmo pedido. Essa oferta estará disponível para todos os canais oficiais Nespresso: Boutiques Nespresso, telefone 0800 7777 737, WhatsApp (11) 95578-4670, site www.Nespresso.com ou aplicativos para iPhone, iPad e Android.<br><br>

Na compra de 200 a 269 cápsulas, durante o período supramencionado, o consumidor ganhará Brinde N4 Nespresso, concedido apenas em pedidos que (i) contenham cápsulas exclusivamente da linha Original ou, (ii) que contenham, de forma combinada, cápsulas das linhas Original e Vertuo dentro de um mesmo pedido. Essa oferta estará disponível para todos os canais oficiais Nespresso: Boutiques Nespresso, telefone 0800 7777 737, WhatsApp (11) 95578-4670, site www.Nespresso.com ou aplicativos para iPhone, iPad e Android.<br><br>

Na compra de 150 a 199 cápsulas, durante o período supramencionado, o consumidor ganhará Brinde N3 Nespresso, concedido apenas em pedidos que (i) contenham cápsulas exclusivamente da linha Original ou, (ii) que contenham, de forma combinada, cápsulas das linhas Original e Vertuo dentro de um mesmo pedido. Essa oferta estará disponível para todos os canais oficiais Nespresso: Boutiques Nespresso, telefone 0800 7777 737, WhatsApp (11) 95578-4670, site www.Nespresso.com ou aplicativos para iPhone, iPad e Android.<br><br>

Na compra de 100 a 149 cápsulas, durante o período supramencionado, o consumidor ganhará Brinde N2 Nespresso, concedido apenas em pedidos que (i) contenham cápsulas exclusivamente da linha Original ou, (ii) que contenham, de forma combinada, cápsulas das linhas Original e Vertuo dentro de um mesmo pedido. Essa oferta estará disponível para todos os canais oficiais Nespresso: Boutiques Nespresso, telefone 0800 7777 737, WhatsApp (11) 95578-4670, site www.Nespresso.com ou aplicativos para iPhone, iPad e Android.<br><br>

Na compra de 70 a 99 cápsulas, durante o período supramencionado, o consumidor ganhará Brinde N1 Nespresso, concedido apenas em pedidos que (i) contenham cápsulas exclusivamente da linha Original ou, (ii) que contenham, de forma combinada, cápsulas das linhas Original e Vertuo dentro de um mesmo pedido. Essa oferta estará disponível para todos os canais oficiais Nespresso: Boutiques Nespresso, telefone 0800 7777 737, WhatsApp (11) 95578-4670, site www.Nespresso.com ou aplicativos para iPhone, iPad e Android.<br><br>

<strong>Para pedidos que contenham exclusivamente cápsulas da linha Vertuo:</strong><br><br>

Na compra a partir de 210 cápsulas, durante o período supramencionado, o consumidor ganhará Brinde N5 Nespresso, concedido apenas em pedidos que contenham exclusivamente cápsulas da linha Vertuo. Essa oferta estará disponível para todos os canais oficiais Nespresso: Boutiques Nespresso, telefone 0800 7777 737, WhatsApp (11) 95578-4670, site www.Nespresso.com ou aplicativos para iPhone, iPad e Android.<br><br>

Na compra de 180 a 209 cápsulas, durante o período supramencionado, o consumidor ganhará Brinde N4 Nespresso, concedido apenas em pedidos que contenham exclusivamente cápsulas da linha Vertuo. Essa oferta estará disponível para todos os canais oficiais Nespresso: Boutiques Nespresso, telefone 0800 7777 737, WhatsApp (11) 95578-4670, site www.Nespresso.com ou aplicativos para iPhone, iPad e Android.<br><br>

Na compra de 120 a 179 cápsulas, durante o período supramencionado, o consumidor ganhará Brinde N3 Nespresso, concedido apenas em pedidos que contenham exclusivamente cápsulas da linha Vertuo. Essa oferta estará disponível para todos os canais oficiais Nespresso: Boutiques Nespresso, telefone 0800 7777 737, WhatsApp (11) 95578-4670, site www.Nespresso.com ou aplicativos para iPhone, iPad e Android.<br><br>

Na compra de 70 a 119 cápsulas, durante o período supramencionado, o consumidor ganhará Brinde N2 Nespresso, concedido apenas em pedidos que contenham exclusivamente cápsulas da linha Vertuo. Essa oferta estará disponível para todos os canais oficiais Nespresso: Boutiques Nespresso, telefone 0800 7777 737, WhatsApp (11) 95578-4670, site www.Nespresso.com ou aplicativos para iPhone, iPad e Android.<br><br>

Na compra de 50 a 69 cápsulas, durante o período supramencionado, o consumidor ganhará Brinde N1 Nespresso, concedido apenas em pedidos que contenham exclusivamente cápsulas da linha Vertuo. Essa oferta estará disponível para todos os canais oficiais Nespresso: Boutiques Nespresso, telefone 0800 7777 737, WhatsApp (11) 95578-4670, site www.Nespresso.com ou aplicativos para iPhone, iPad e Android.`,
    },
  };
  // ===== FIM DA CONFIGURAÇÃO =====
  ...
  function createComponent() {
    ...
    accordionContainer.innerHTML =
      ...
      gerarOfertasHTML() +
      `
            <a class="linkCondicoesOfertaBoostSetembro" id="verCondicoesLink">*Veja condições</a>
          </div>
        </div>
      </div>
    `;
    ...
    modalElement.innerHTML =
      ...
      `</h3>
        ...
        <div class="modal-content">
          <div class="modalTermosECondicoesBoostSetembro">
            ` +
    ...
    styleElement.textContent = `
      ...
      .nespresso-accordion .linkCondicoesOfertaBoostSetembro{
        font-size:12px;
        text-align:center;
        display:block;
