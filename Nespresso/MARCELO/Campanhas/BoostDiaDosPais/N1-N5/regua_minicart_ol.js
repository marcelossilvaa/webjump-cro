(function () {
  if (window.boostDiaDosPaisProgressBar) {
    return;
  }
  ...
  window.boostDiaDosPaisProgressBar = "true";
    ...
    styleEl.textContent = `
              .MiniBasketDropdown__wrapper .BenefitMessage, .MiniBasketDropdown__wrapper #minicart-freight-component, #MiniBasketPush{
                    ...
                    .nespresso-tooltip .nespresso-tooltip-text::after {
                      ...
                      border-width: 5px;
                      border-style: solid;
                      border-color: #ab2418 transparent transparent transparent;
                    }
  ...
  const createOffersComponent = () => {
    ...
    container.id = "nespresso-boost-dia-dos-pais-offers";
  ...
  const renderOffersComponent = (container, totalCapsules) => {
      ...
      if (tierInfo.nextTier) {
        mobileHtml =
          ...
          ` cápsulas</span>
              ...
              <p style="font-size: 12px; color: #ab2418; margin: 0; font-weight: 700;">
                e ganhe: ` +
          ...
          `
            ...
            <div style="flex-shrink: 0;">
              <div style="width: 70px; height: 70px; border-radius: 50%; border: 3px solid #ab2418; overflow: hidden; background-color: #fff;">
                <img src="` +
        ...
        mobileHtml =
          ...
          <div style="display: flex; align-items: center; justify-content: space-between; padding: 12px 8px; gap: 12px;">
            <div style="flex: 1; text-align: left;">
              <p style="font-size: 13px; color: #ab2418; margin: 0 0 4px 0; font-weight: 600;">
              Parabéns!
              </p>
              <p style="font-size: 12px; color: #ab2418; margin: 0; font-weight: 700;">
    ...
    if (tierInfo.nextTier) {
      ...
      nextTierInfoHtml = `
                <div style="text-align: center; padding: 8px 0; margin-top: 8px;">
                  <span style="font-size: 11px; color: #ab2418; font-weight: 500;">
    ...
    // html += `<span class="credito_span_regua_oferta" style="display: block;text-align: center;font-size: 11px;color: #ab2418;margin-top: 6px;">*Crédito disponível em até 48h</span>`;
