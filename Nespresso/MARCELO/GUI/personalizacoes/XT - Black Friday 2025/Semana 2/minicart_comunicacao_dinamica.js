(function () {
  ...
  const capsuleGiftTiers = [
    {
      html: '<div style="padding:8px 0;text-align:center">\
          <div style="display:inline-block;padding:8px 12px; font-size: 14px;background-color: #BE4191;border-radius: 6px; color:#fff;">\
  ...
  const machineGiftTiers = [
    {
      html: '<div style="padding:8px 0;text-align:center">\
          <div style="display:inline-block;padding:8px 12px; font-size: 16px;background-color: #BE4191;border-radius: 6px; color:#fff;">\
