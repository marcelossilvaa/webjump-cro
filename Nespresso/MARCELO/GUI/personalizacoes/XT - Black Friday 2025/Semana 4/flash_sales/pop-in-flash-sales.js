(function () {
  "use strict";
  if (window.popinFlashSalesInitialized) return;
  window.popinFlashSalesInitialized = true;
  ...
  function sendGAEvent(action, label) {
    ...
    gtmDataObject.push({
      ...
      local_event_category: "pop-in-flash-sales", //free to fill field, please use lower case
  ...
  <div class="close" onclick="document.getElementById('custom-popin').remove()">
    ×
  </div>
  <div class="content" id="container_redirecionamento">
    <div class="title">OFERTA RELÂMPAGO</div>
    <div class="desc">
      GANHE<span style="font-weight: 700;"> 40% OFF</span> EM
      KITS SELECIONADOS. <span style="font-weight: 700;">CONFIRA!</span>
    </div>
  </div>
  <div class="image">
    <img
      src="https://www.nespresso.com/ecom/medias/sys_master/public/46622037213214/Pop-in.jpg?attachment=true&cimgnr=Ww5oF"
      alt="Imagem porta cápsulas flash sales"
    />
  </div>
</div>`
    );
  ...
  function inicializarRedirecionamento() {
    ...
    const urlMobile = "https://www.nespresso.com/br/pt/order/capsules/original";
    ...
    elemento.addEventListener("click", function () {
      ...
      sendGAEvent("click", "click_pop_in_flash_sales");
      window.location.href = urlDestino;
    });
  }
  function fecharPopin() {
    sendGAEvent("click", "close_pop_in_flash_sales");
    try {
