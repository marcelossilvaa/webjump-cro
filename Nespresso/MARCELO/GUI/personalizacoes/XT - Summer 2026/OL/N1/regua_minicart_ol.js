(function () {
  ...
  const giftTiers = [
    {
      threshold: 70,
      gift: "10 Cafés Pistachio",
      shortName: "10 cafés Pistachio",
      displayName: "GANHE 10 CAFÉS PISTACHIO",
      imageUrl:
        "https://www.nespresso.com/ecom/medias/sys_master/public/47339351605278/Icone-N1-OL.jpg?attachment=true&cimgnr=7H6IO", // Substitua pela URL da imagem real
    },
    {
      threshold: 100,
      gift: "1 Kit para Drinks",
      shortName: "1 Kit para Drinks",
      displayName: "1 KIT PARA DRINKS",
      imageUrl:
        "https://www.nespresso.com/ecom/medias/sys_master/public/47338203086878/Icone-N2.jpg?attachment=true&cimgnr=SoeL5", // Substitua pela URL da imagem real
    },
    {
      threshold: 150,
      gift: "1 Copo para Drinks + 1 Forma de Gelo",
      shortName: "1 Copo para Drinks + 1 Forma de Gelo",
      displayName: "1 COPO PARA DRINKS + 1 FORMA DE GELO",
      imageUrl:
        "https://www.nespresso.com/ecom/medias/sys_master/public/47339941789726/Icone-N3.jpg?attachment=true&cimgnr=y4VqT", // Substitua pela URL da imagem real
    },
    {
      threshold: 200,
      gift: "1 Bolsa Térmica",
      shortName: "1 Bolsa Térmica",
      displayName: "1 BOLSA TÉRMICA",
      imageUrl:
        "https://www.nespresso.com/ecom/medias/sys_master/public/47338203316254/Icone-N4.jpg?attachment=true&cimgnr=bo9em", // Substitua pela URL da imagem real
    },
    {
      threshold: 250,
      gift: "1 Caneca Térmica Grande",
      shortName: "1 Caneca Térmica Grande",
      displayName: "1 CANECA TÉRMICA GRANDE",
      imageUrl:
        "https://www.nespresso.com/ecom/medias/sys_master/public/47338203775006/Icone-N5.jpg?attachment=true&cimgnr=rZuGC", // Substitua pela URL da imagem real
    },
  ];
    ...
    styleEl.textContent = `
              .MiniBasketDropdown__wrapper .BenefitMessage, .MiniBasketDropdown__wrapper #minicart-freight-component, #MiniBasketPush{
                    ...
                    .nespresso-shimmer-effect {
                      ...
                      border:3px solid #002354 !important;
        ...
        mobileHtml =
          ...
          <div style="display: flex; align-items: center; justify-content: space-between; padding: 0px 25px; gap: 12px;">
            <div style="flex: 1; text-align: left;">
              <p style="font-size: 13px; color: #000; margin: 0 0 6px 0; font-weight: 600;">
                Adicione mais <span style="background-color: rgb(187, 217, 150); padding: 2px 6px; border-radius: 4px; font-weight: 700;">` +
          tierInfo.capsulesToNextTier +
          ` cápsulas</span>
              </p>
              <p style="font-size: 12px; color: #002354; margin: 0; font-weight: 700;">
                e ganhe: ` +
          ...
          `
            ...
            <div style="flex-shrink: 0;">
              <div style="width: 70px; height: 70px; border-radius: 50%; border: 3px solid #002354; overflow: hidden; background-color: #fff;">
                <img src="` +
                  ...
                  <div style="display: flex; align-items: center; justify-content: space-between; border-radius: 6px; padding: 2px 8px;">
                    <div style="flex: 1; display:flex; align-items:center;justify-content:space-evenly;">
                      <p style="font-size: 12px; color: #000; margin: 0 0 2px 0;text-align:center">
                        <strong>Adicione mais <span style="background-color: rgb(187, 217, 150); padding: 2px 4px;border-radius: 4px;">` +
        tierInfo.capsulesToNextTier +
        ` cápsulas</span></strong> para ganhar: <span style="font-size: 13px; color: #002354; font-weight: 700; margin: 0;">` +
        tierInfo.nextTier.gift +
        `</span>
                      </p>
                    </div>
