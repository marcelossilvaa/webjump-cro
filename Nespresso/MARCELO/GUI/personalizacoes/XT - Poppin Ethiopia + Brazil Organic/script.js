(function () {
  if (window.poppinBoostCafes) {
    return;
  }
  window.poppinBoostCafes = "true";
  const CAFE_POP_IN_URL =
    "https://www.nespresso.com/br/pt/order/capsules/original/capsulas-cafe-nespresso-brazil-organic";
  ...
  function iniciarContainer() {
    var config = {
      imagemUrl: "https://iili.io/3JDJOmX.png",
    ...
    link.addEventListener("click", function () {
      sendEventGA("clicou_comunicacao_brazil_organic");
    });
    botaoFechar.addEventListener("click", function (e) {
      sendEventGA("fechou_comunicacao_brazil_organic");
      e.preventDefault();
      e.stopPropagation();
    ...
    if (!jaFechado) {
      ...
      sendEventGA("visualizou_comunicacao_brazil_organic");
  ...
  if (
    ...
    window.padl.page.pageInfo.pageName === "capsules pdp" ||
    window.padl.page.pageInfo.pageName === "homepage"
  ) {
    if (window.location.href !== CAFE_POP_IN_URL) {
