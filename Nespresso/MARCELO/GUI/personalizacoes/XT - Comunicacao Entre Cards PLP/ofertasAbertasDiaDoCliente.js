  ...
  const CARDS_CONFIG = [
    {
      ...
      variants: {
        ol: {
          ...
          paragrafo: "Experimente a linha Master Origins <br>Brazil Organic",
    ...
    },
    {
      ...
      variants: {
        ol: {
          banner:
            "https://www.nespresso.com/ecom/medias/sys_master/public/45978546667550/Card-PLP-432x692-Colombia-OL-V2.jpg?attachment=true&cimgnr=9AY15",
          paragrafo: "Experimente a linha Master Origins Colombia",
          ctaText: "ADICIONAR AO CARRINHO",
          ctaAction: "addToCart",
          ctaSKU: "7894.90",
    ...
    },
    {
      ...
      variants: {
        ol: {
          banner:
            "https://www.nespresso.com/ecom/medias/sys_master/public/46014058758174/imagem-29-.png?attachment=true&cimgnr=EP0Gl",
        },
        vl: {
          banner:
            "https://www.nespresso.com/ecom/medias/sys_master/public/46021883265054/Card-PLP-VL-N3.jpg?attachment=true&cimgnr=OkAJg",
        },
      },
    },

    {
      id: "dia-do-cliente-n4",
      enabled: true,
      position: 5,
      targetCollections: [
        //Original
      ...
      variants: {
        ol: {
          banner:
            "https://www.nespresso.com/ecom/medias/sys_master/public/46021883658270/Card-PLP-OL-N4.jpg?attachment=true&cimgnr=MsTUh",
        },
        vl: {
          banner:
            "https://www.nespresso.com/ecom/medias/sys_master/public/46021883396126/Card-PLP-VL-N4.jpg?attachment=true&cimgnr=BOHYz",
        },
      },
    },
    {
      id: "dia-do-cliente-n5",
      enabled: true,
      position: 5,
      targetCollections: [
        //Original
      ...
      variants: {
        ol: {
          banner:
            "https://www.nespresso.com/ecom/medias/sys_master/public/46021883592734/Card-PLP-OL-N5.jpg?attachment=true&cimgnr=MkEXA",
        },
      },
    },
  ];
