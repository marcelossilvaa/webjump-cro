...
!(function () {
  ...
  var e = window.location.href.split("/")[3],
    t = document.querySelector("html").attributes.lang.value,
    o = window.Translations[e][t];
  new MutationObserver((e, t) => {
    if (document.querySelector(".PageCheckout")) {
      ...
      let e = document.querySelector("#shoppingbag-form"),
        t = document.querySelector("#shippingInfoDTO"),
        o = document.querySelector("#paymentInfoDTO"),
        n = document.querySelector(".delivery-footer");
      if (e) {
        new IntersectionObserver(
          function (e) {
            r(e, ".responsive-shopping-bag__controls", "isSticky");
          },
          { threshold: [0, 1] }
        ).observe(e),
          document.querySelector(".stickey-container") ||
            (i(
            ...
            (function () {
              let e = document.querySelectorAll(
                "#shoppingbag-form .responsive-shopping-bag__proceed--bottom"
              )[0];
              e &&
                e.hasAttribute("disabled") &&
                (document.querySelector("#CTA-dummy").disabled = "true");
            })());
      }
      if (t) {
        new IntersectionObserver(
          function (e) {
            r(e, "#ta-continue-bottom", "isSticky");
          },
          { threshold: [0, 1] }
        ).observe(n),
          document.querySelector(".stickey-container") ||
            i(".delivery-footer", "#ta-continue-bottom", "stepTwoCTALabel");
      }
      if (o) {
        new IntersectionObserver(
          function (e) {
          ...
          document.querySelector(".stickey-container") ||
            i(".delivery-footer", "#ta-continue-bottom", "stepThreeCTALabel");
      }
    }
  }).observe(document.querySelector(".responsive-registration.steps-nav"), {
    attributes: !0,
    childList: !0,
    subtree: !0,
  });
  const n = new MutationObserver((e, t) => {
    const o = document.querySelector("#ta-continue-bottom");
    o && o.hasAttribute("disabled")
      ? (document.querySelector("#CTA-dummy").disabled = !0)
      : (document.querySelector("#CTA-dummy").disabled = !1);
  });
  function i(e, t, n) {
    let i = `<div class="stickey-container"><div class="centering-section"><div class="total-container"><span class="loading"><svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30px" height="30px" viewBox="-2.63 -2.63 31.61 31.61" xml:space="preserve"><g id="SVGRepo_bgCarrier" stroke-width="0"/><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.158094"/><g id="SVGRepo_iconCarrier"><g><g><circle cx="13.792" cy="3.082" r="3.082"/><circle cx="13.792" cy="24.501" r="1.849"/><circle cx="6.219" cy="6.218" r="2.774"/><circle cx="21.365" cy="21.363" r="1.541"/><circle cx="3.082" cy="13.792" r="2.465"/><circle cx="24.501" cy="13.791" r="1.232"/><path d="M4.694,19.84c-0.843,0.843-0.843,2.207,0,3.05c0.842,0.843,2.208,0.843,3.05,0c0.843-0.843,0.843-2.207,0-3.05 C6.902,18.996,5.537,18.988,4.694,19.84z"/><circle cx="21.364" cy="6.218" r="0.924"/></g></g></g></svg></span></div><button type="submit" id="CTA-dummy" class="btn-container btn button-primary button-right-icon responsive-shopping-bag__proceed--bottom"><span class="button__content">`+o[n]+`</span><i class="responsive-icon Glyph Glyph--arrow-right" aria-hidden="true"></i></button></div></div>`;
    document.querySelector(e).insertAdjacentHTML("afterend", i),
      document
        .querySelector("#CTA-dummy")
        ...
        t.length > 0
          ...
          e &&
            ...
            i.insertAdjacentHTML(
              "afterbegin",
              `<span class="total-text">`+o.totalLabel+`</span><span class="total-value">`+e+`</span>`
            ));
      }, 500);
  }
  function r(e, t, o) {
  ...
  !(function e() {
    var t = document.querySelector("#ta-continue-bottom");
    if (t) {
