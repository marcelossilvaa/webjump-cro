(function () {
  ...
  const STYLE_ID = 'at-333-new-banner-style-v2';
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '  border-radius: 25px !important;',
      '}',
      '.pagebuilder-lazyload-slider img[data-element="desktop_image"],',
      '.pagebuilder-lazyload-slider img[data-element="mobile_image"] {',
      '  border-radius: 25px !important;',
      '}',
      ...
      '  border-radius: 25px !important;',
      '}',
      MOBILE_CAROUSEL_SELECTOR + ' img.carousel-image-mobile {',
      '  border-radius: 25px !important;',
      '}',
      '@media only screen and (max-width: 768px) {',
      ...
      '  }',
      '  ' + MOBILE_CAROUSEL_SELECTOR + ' .carousel-wrapper,',
      '  ' + MOBILE_CAROUSEL_SELECTOR + ' .carousel-items {',
      '    touch-action: pan-y !important;',
      '  }',
      '}',
