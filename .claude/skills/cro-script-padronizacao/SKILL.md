...
description: >-
  ...
  usuário pedir conformidade com .cursor/rules.
---
...
- Garantir alinhamento com `/.cursor/rules/` (ver módulos em `rules/01-` a `99-`).
...
- `/.cursor/rules/` — regras por tema
- `/.cursor/regras.md` — índice
